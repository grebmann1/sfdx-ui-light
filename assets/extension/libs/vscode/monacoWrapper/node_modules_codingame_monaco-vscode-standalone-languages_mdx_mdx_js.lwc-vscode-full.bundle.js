"use strict";
(self["webpackChunkmonaco_languageclient_lwc"] = self["webpackChunkmonaco_languageclient_lwc"] || []).push([["node_modules_codingame_monaco-vscode-standalone-languages_mdx_mdx_js"],{

/***/ "./node_modules/@codingame/monaco-vscode-standalone-languages/mdx/mdx.js"
/*!*******************************************************************************!*\
  !*** ./node_modules/@codingame/monaco-vscode-standalone-languages/mdx/mdx.js ***!
  \*******************************************************************************/
...
const conf = {
  ...
  onEnterRules: [
    {
      beforeText: /^\s*- .+/,
      action: { indentAction: monaco_editor__WEBPACK_IMPORTED_MODULE_0__.languages.IndentAction.None, appendText: "- " }
    },
    {
      beforeText: /^\s*\+ .+/,
      action: { indentAction: monaco_editor__WEBPACK_IMPORTED_MODULE_0__.languages.IndentAction.None, appendText: "+ " }
    ...
    {
      beforeText: /<\w+/,
      action: { indentAction: monaco_editor__WEBPACK_IMPORTED_MODULE_0__.languages.IndentAction.Indent }
    },
    {
      beforeText: /\s+>\s*$/,
      action: { indentAction: monaco_editor__WEBPACK_IMPORTED_MODULE_0__.languages.IndentAction.Indent }
    ...
    {
      beforeText: /<\/\w+>/,
      action: { indentAction: monaco_editor__WEBPACK_IMPORTED_MODULE_0__.languages.IndentAction.Outdent }
    },
    ...Array.from({ length: 100 }, (_, index) => ({
      beforeText: new RegExp(`^${index}\\. .+`),
      action: { indentAction: monaco_editor__WEBPACK_IMPORTED_MODULE_0__.languages.IndentAction.None, appendText: `${index + 1}. ` }
    }))
  ]
};
const language = {
