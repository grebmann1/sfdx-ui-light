...
export const API_COLORS: Record<string, string> = {
    queryable: 'badge-blue',
    searchable: 'badge-blue',
    createable: 'badge-green',
    updateable: 'badge-green',
    deletable: 'badge-red',
    layoutable: 'badge-teal',
    retrieveable: 'badge-teal',
};
