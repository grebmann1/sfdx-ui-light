...
import { ROLES, fetchCompletion, fetchCompletionStream } from 'ai/utils';
...
class Assistant {
    ...
    constructor({
        ...
        const appState = getStore()?.getState?.()?.application || {};
        this.aiProvider = aiProvider || appState.aiProvider || 'openai';
        this.openaiKey = openaiKey || appState.openaiKey || '';
