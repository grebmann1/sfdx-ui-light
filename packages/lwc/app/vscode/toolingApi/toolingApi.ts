...
function normalizeInstanceUrl(instanceUrl: string | null | undefined): string {
...
function normalizeProxyUrl(proxyUrl: string | null | undefined): string {
...
function normalizeApiVersion(apiVersion: string | null | undefined): string {
...
function toPath(urlOrPath: string | null | undefined, instanceUrl: string): string {
