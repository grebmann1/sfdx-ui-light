import { WORKSPACE_TEMPLATE_FILES } from './templates/workspace/index.js';
...
function prefixWorkspaceFiles(workspaceRoot, files) {
    const rooted = {};
...
export async function buildWorkspaceBootstrap(connection, workspaceBasePath = '/workspace/orgs') {
