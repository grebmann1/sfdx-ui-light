    ...
    @track steps = [
        {
            ...
            description:
                'For the best experience, pin the Workbench 2.0 extension to your browser toolbar. </br> Click the puzzle icon (Extensions), then click the pin next to Workbench 2.0. Once pinned, click the extension icon to open it and view your credentials instantly.',
        ...
        },
        {
            ...
            description:
                'To get started, open the Workbench 2.0 by clicking the extension icon in your browser toolbar. You can also use the keyboard shortcut shown below. Watch the animation for a quick demonstration.',
        ...
        },
        {
            ...
            description:
                'With Workbench 2.0, you can easily query and export your Salesforce data in just a few clicks. Use the built-in SOQL editor to run queries and export results to CSV. </br> You can even set up a custom shortcut for quick access to the query tool directly from the settings!',
        ...
        },
        {
            ...
            class: 'slds-dot',
            title: 'Ready to Go!',
            description: `You\'re all set to start using Workbench 2.0. </br> The extension will automatically activate when you visit Salesforce pages.</br> </br>If you have more questions or want to contribute, visit our GitHub page: <a href="https://github.com/grebmann1/sfdx-ui-light" target="_blank">https://github.com/grebmann1/sfdx-ui-light</a>`,
            list: [
