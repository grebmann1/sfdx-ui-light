"use strict";
(self["webpackChunkmonaco_languageclient_lwc"] = self["webpackChunkmonaco_languageclient_lwc"] || []).push([["vendors-node_modules_codingame_monaco-vscode-api_vscode_src_vs_base_common_glob_js"],{
...
/* harmony export */   isEmptyPattern: () => (/* binding */ isEmptyPattern),
...
/* harmony import */ var _async_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./async.js */ "./node_modules/@codingame/monaco-vscode-api/vscode/src/vs/base/common/async.js");
/* harmony import */ var _charCode_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./charCode.js */ "./node_modules/@codingame/monaco-vscode-api/vscode/src/vs/base/common/charCode.js");
/* harmony import */ var _extpath_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./extpath.js */ "./node_modules/@codingame/monaco-vscode-api/vscode/src/vs/base/common/extpath.js");
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./map.js */ "./node_modules/@codingame/monaco-vscode-api/vscode/src/vs/base/common/map.js");
/* harmony import */ var _path_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./path.js */ "./node_modules/@codingame/monaco-vscode-api/vscode/src/vs/base/common/path.js");
/* harmony import */ var _platform_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./platform.js */ "./node_modules/@codingame/monaco-vscode-api/vscode/src/vs/base/common/platform.js");
/* harmony import */ var _strings_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./strings.js */ "./node_modules/@codingame/monaco-vscode-api/vscode/src/vs/base/common/strings.js");
...
function parsePattern(arg1, options) {
    ...
    const internalOptions = {
        ...options,
        equals: ignoreCase ? _strings_js__WEBPACK_IMPORTED_MODULE_7__.equalsIgnoreCase : (a, b) => a === b,
        endsWith: ignoreCase ? _strings_js__WEBPACK_IMPORTED_MODULE_7__.endsWithIgnoreCase : (str, candidate) => str.endsWith(candidate),
        isEqualOrParent: (base, candidate) => (0,_extpath_js__WEBPACK_IMPORTED_MODULE_3__.isEqualOrParent)(base, candidate, !_platform_js__WEBPACK_IMPORTED_MODULE_6__.isLinux || ignoreCase)
    };
...
function wrapRelativePattern(parsedPattern, arg2, options) {
    ...
    const wrappedPattern = function(path, basename) {
        ...
        return parsedPattern((0,_strings_js__WEBPACK_IMPORTED_MODULE_7__.ltrim)(path.substring(arg2.base.length), _path_js__WEBPACK_IMPORTED_MODULE_5__.sep), basename);
    };
    ...
    const resultExpression = function(path, base, hasSibling) {
        ...
        for (let i = 0, n = parsedPatterns.length; i < n; i++) {
            ...
            if (parsedPattern.requiresSiblings && hasSibling) {
                ...
                if (!name) {
                    name = base.substring(0, base.length - (0,_path_js__WEBPACK_IMPORTED_MODULE_5__.extname)(path).length);
                }
            }
    ...
    if (value) {
        ...
        if (typeof when === "string") {
            const result = (path, basename, name, hasSibling) => {
                ...
                return (0,_async_js__WEBPACK_IMPORTED_MODULE_1__.isThenable)(matched) ? matched.then(match => match ? pattern : null) : matched ? pattern : null;
            };
