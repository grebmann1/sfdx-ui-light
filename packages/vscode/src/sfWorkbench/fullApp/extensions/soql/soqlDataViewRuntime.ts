...
function replaceDataViewTemplateAssets({
    ...
    const baseStyleUri = String(
        webview.asWebviewUri(vscode.Uri.file(`${DATA_VIEW_TARGET_ROOT}/queryDataView.css`))
    );
    const tabulatorStyleUri = String(
        webview.asWebviewUri(vscode.Uri.file(`${DATA_VIEW_TARGET_ROOT}/tabulator.min.css`))
    );
    const viewControllerUri = String(
        webview.asWebviewUri(vscode.Uri.file(`${DATA_VIEW_TARGET_ROOT}/queryDataViewController.js`))
    );
    const tabulatorUri = String(
        webview.asWebviewUri(vscode.Uri.file(`${DATA_VIEW_TARGET_ROOT}/tabulator.min.js`))
    );
    const saveIconUri = String(
        webview.asWebviewUri(vscode.Uri.file(`${DATA_VIEW_TARGET_ROOT}/icons/icon__save.svg`))
    );
