...
let _activeCoreServices: CoreServices | null = null;

export function setActiveCoreServices(services: CoreServices | null): void {
    _activeCoreServices = services;
}

export function getActiveCoreServices(): CoreServices | null {
    return _activeCoreServices;
}
...
function attachHostServices(host: NonNullSalesforceHost): ResolvedCoreServices {
    return {
        ...
        orgContext: getWorkbenchOrgContext(),
    };
}
