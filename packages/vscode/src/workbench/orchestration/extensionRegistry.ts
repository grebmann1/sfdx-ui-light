...
import { register as registerLana } from '../extensions/lana/extension';
import { register as registerLogs } from '../extensions/logs/extension';
...
> = [
    ...
    (vscodeBundle, ctx) => registerLogs(vscodeBundle, ctx),
    ...
    (vscodeBundle, ctx) => registerLana(vscodeBundle, ctx),
];
