...
var ko = (e, t, n) => t in e ? To(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var Fe = (e, t, n) => (ko(e, typeof t != "symbol" ? t + "" : t, n), n);
class Ao {
  constructor() {
...
const Pn = "Canceled";
function Lo(e) {
  return e instanceof Co ? !0 : e instanceof Error && e.name === Pn && e.message === Pn;
}
...
(function(e) {
  ...
  e.reduce = k;
  function* y(M, D, N = M.length) {
    for (D < 0 && (D += M.length), N < 0 ? N += M.length : N > M.length && (N = M.length); D < N; D++)
      yield M[D];
  }
  e.slice = y;
  function v(M, D = Number.POSITIVE_INFINITY) {
    const N = [];
    if (D === 0)
      return [N, M];
...
const vn = class vn {
  ...
  add(t) {
    ...
    return this._isDisposed ? vn.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
  /**
...
const No = globalThis.performance && typeof globalThis.performance.now == "function";
class Ln {
  static create(t) {
    return new Ln(t);
  }
  constructor(t) {
    this._now = No && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(S) {
    return (w, A = null, R) => {
      ...
      return F = S((H) => {
        if (!I)
          return F ? F.dispose() : I = !0, w.call(A, H);
      }, null, R), I && F.dispose(), F;
    };
  }
  e.once = n;
  function i(S, w) {
    return e.once(e.filter(S, w));
  }
  e.onceIf = i;
  function r(S, w, A) {
    return c((R, I = null, F) => S((H) => R.call(I, w(H)), null, F), A);
  }
  e.map = r;
  function s(S, w, A) {
    return c((R, I = null, F) => S((H) => {
      w(H), R.call(I, H);
    }, null, F), A);
  }
  e.forEach = s;
  function a(S, w, A) {
    return c((R, I = null, F) => S((H) => w(H) && R.call(I, H), null, F), A);
  }
  e.filter = a;
  function l(S) {
    return S;
  ...
  function o(...S) {
    return (w, A = null, R) => {
      const I = Ro(...S.map((F) => F((H) => w.call(A, H))));
      return d(I, R);
    };
  }
  e.any = o;
  ...
  function c(S, w) {
    ...
    return w == null || w.add(I), I.event;
  }
  function d(S, w) {
    return w instanceof Array ? w.push(S) : w && w.add(S), S;
  }
  function m(S, w, A = 100, R = !1, I = !1, F, H) {
    let W, q, J, se = 0, de;
    const Cn = {
      leakWarningThreshold: F,
      onWillAddFirstListener() {
        W = S((yo) => {
          se++, q = w(q, yo), R && !J && (Ft.fire(q), q = void 0), de = () => {
            const xo = q;
            q = void 0, J = void 0, (!R || se > 1) && Ft.fire(xo), se = 0;
          }, typeof A == "number" ? (clearTimeout(J), J = setTimeout(de, A)) : J === void 0 && (J = 0, queueMicrotask(de));
        });
      },
    ...
    return H == null || H.add(Ft), Ft.event;
  }
  e.debounce = m;
  function f(S, w = 0, A) {
    return e.debounce(S, (R, I) => R ? (R.push(I), R) : [I], w, void 0, !0, void 0, A);
  }
  e.accumulate = f;
  function _(S, w = (R, I) => R === I, A) {
    let R = !0, I;
    return a(S, (F) => {
      const H = R || !w(F, I);
      return R = !1, I = F, H;
  ...
  e.split = g;
  function k(S, w = !1, A = [], R) {
    let I = A.slice(), F = S((q) => {
      I ? I.push(q) : W.fire(q);
    });
    R && R.add(F);
    const H = () => {
      I == null || I.forEach((q) => W.fire(q)), I = null;
    }, W = new ve({
      onWillAddFirstListener() {
        F || (F = S((q) => W.fire(q)), R && R.add(F));
      },
  ...
  class C {
    ...
    forEach(w) {
      return this.steps.push((A) => (w(A), A)), this;
    }
    filter(w) {
      return this.steps.push((A) => w(A) ? A : v), this;
    }
    reduce(w, A) {
      let R = A;
      return this.steps.push((I) => (R = w(R, I), R)), this;
    }
    latch(w = (A, R) => A === R) {
      let A = !0, R;
      return this.steps.push((I) => {
        const F = A || !w(I, R);
        return A = !1, R = I, F ? I : v;
      }), this;
    }
    evaluate(w) {
  ...
  function M(S, w, A = (R) => R) {
    const R = (...W) => H.fire(A(...W)), I = () => S.on(w, R), F = () => S.removeListener(w, R), H = new ve({ onWillAddFirstListener: I, onDidRemoveLastListener: F });
    return H.event;
  }
  e.fromNodeEventEmitter = M;
  function D(S, w, A = (R) => R) {
    const R = (...W) => H.fire(A(...W)), I = () => S.addEventListener(w, R), F = () => S.removeEventListener(w, R), H = new ve({ onWillAddFirstListener: I, onDidRemoveLastListener: F });
    return H.event;
  }
  e.fromDOMEventEmitter = D;
  function N(S) {
    return new Promise((w) => n(S)(w));
  }
  e.toPromise = N;
  function b(S) {
    const w = new ve();
  ...
  class U {
    constructor(w, A) {
      ...
      this.emitter = new ve(R), A && A.add(this.emitter);
    }
    beginUpdate(w) {
      this._counter++;
    }
  ...
  function L(S, w) {
    return new U(S, w).emitter.event;
  }
  e.fromObservable = L;
  function T(S) {
    return (w, A, R) => {
      ...
      const H = {
        ...
        endUpdate() {
          I--, I === 0 && (S.reportChanges(), F && (F = !1, w.call(A)));
        },
      ...
      S.addObserver(H), S.reportChanges();
      const W = {
        dispose() {
          S.removeObserver(H);
        }
      };
      return R instanceof Dt ? R.add(W) : Array.isArray(R) && R.push(W), W;
    };
  }
...
const ut = class ut {
  constructor(t) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${ut._idPool++}`, ut.all.add(this);
  }
  start(t) {
    this._stopWatch = new Ln(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
ut.all = /* @__PURE__ */ new Set(), ut._idPool = 0;
let Bn = ut, Do = -1;
const yn = class yn {
  constructor(t, n, i = (yn._idPool++).toString(16).padStart(3, "0")) {
...
class ve {
  ...
  get event() {
    return this._event ?? (this._event = (t, n, i) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(m);
        const f = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], _ = new zo(`${m}. HINT: Stack shows most frequent listener (${f[1]}-times)`, f[0]);
        return (((l = this._options) == null ? void 0 : l.onListenerError) || At)(_), gt.None;
      }
      if (this._disposed)
        return gt.None;
      n && (t = t.bind(n));
      const r = new En(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = Ni.create(), s = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof En ? (this._deliveryQueue ?? (this._deliveryQueue = new Ho()), this._listeners = [this._listeners, r]) : this._listeners.push(r) : ((u = (o = this._options) == null ? void 0 : o.onWillAddFirstListener) == null || u.call(o, this), this._listeners = r, (d = (c = this._options) == null ? void 0 : c.onDidAddFirstListener) == null || d.call(c, this)), this._size++;
      const a = Qt(() => {
        s == null || s(), this._removeListener(r);
      });
      return i instanceof Dt ? i.add(a) : Array.isArray(i) && i.push(a), a;
    }), this._event;
  }
  _removeListener(t) {
    var s, a, l, o;
  ...
  _deliver(t, n) {
    ...
    if (!t)
      return;
    const i = ((r = this._options) == null ? void 0 : r.onListenerError) || At;
    if (!i) {
      t.value(n);
      return;
    }
...
const Fo = Va() === "pseudo" || typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function Pi(e, t) {
  let n;
...
function Q(e, t, ...n) {
  return Pi(typeof e == "number" ? Po(e, t) : t, n);
}
function Po(e, t) {
  var i;
  const n = (i = Wo()) == null ? void 0 : i[e];
  if (typeof n != "string") {
    if (typeof t == "string")
      return t;
...
const ot = "en";
let On = !1, Vn = !1, Rn = !1, ja = !1, Di = !1, Pt, Mn = ot, Bi = ot, Bo, Te;
const ze = globalThis;
let le;
var Fa;
typeof ze.vscode < "u" && typeof ze.vscode.process < "u" ? le = ze.vscode.process : typeof process < "u" && typeof ((Fa = process == null ? void 0 : process.versions) == null ? void 0 : Fa.node) == "string" && (le = process);
var Pa;
const qo = typeof ((Pa = le == null ? void 0 : le.versions) == null ? void 0 : Pa.electron) == "string", Oo = qo && (le == null ? void 0 : le.type) === "renderer";
var Ba;
if (typeof le == "object") {
  On = le.platform === "win32", Vn = le.platform === "darwin", Rn = le.platform === "linux", Rn && le.env.SNAP && le.env.SNAP_REVISION, le.env.CI || le.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Pt = ot, Mn = ot;
  const e = le.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      Pt = t.userLocale, Bi = t.osLocale, Mn = t.resolvedLanguage || ot, Bo = (Ba = t.languagePack) == null ? void 0 : Ba.translationsConfigFile;
    } catch {
    }
  ja = !0;
} else
  typeof navigator == "object" && !Oo ? (Te = navigator.userAgent, On = Te.indexOf("Windows") >= 0, Vn = Te.indexOf("Macintosh") >= 0, (Te.indexOf("Macintosh") >= 0 || Te.indexOf("iPad") >= 0 || Te.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Rn = Te.indexOf("Linux") >= 0, (Te == null ? void 0 : Te.indexOf("Mobi")) >= 0, Di = !0, Mn = Va() || ot, Pt = navigator.language.toLowerCase(), Bi = Pt) : console.error("Unable to resolve platform.");
const It = On, Vo = Vn, jo = ja, $o = Di, Go = Di && typeof ze.importScripts == "function", Xo = Go ? ze.origin : void 0, Ne = Te, Jo = typeof ze.postMessage == "function" && !ze.importScripts;
(() => {
  if (Jo) {
    const e = [];
    ...
    return (n) => {
      ...
      e.push({
        id: i,
        callback: n
      }), ze.postMessage({ vscodeScheduleAsyncWork: i }, "*");
    };
  }
  return (e) => setTimeout(e);
})();
const Yo = !!(Ne && Ne.indexOf("Chrome") >= 0);
Ne && Ne.indexOf("Firefox") >= 0;
!Yo && Ne && Ne.indexOf("Safari") >= 0;
Ne && Ne.indexOf("Edg/") >= 0;
...
class Zo {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = Qo) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
Ee.ambiguousCharacterData = new qi(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,8218,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,8242,96,1370,96,1523,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71922,67,71913,67,65315,67,8557,67,8450,67,8493,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71919,87,71910,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,66293,90,71909,90,65338,90,8484,90,8488,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65297,49,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"cs":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"es":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"fr":[65374,126,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"it":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ja":[8211,45,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65292,44,65307,59],"ko":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pt-BR":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ru":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"zh-hans":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41],"zh-hant":[8211,45,65374,126,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65307,59]}')), Ee.cache = new Zo({ getCacheKey: JSON.stringify }, (t) => {
  ...
  const s = Ee.ambiguousCharacterData.value;
  ...
  return new Ee(u);
}), Ee._locales = new qi(() => Object.keys(Ee.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let zt = Ee;
const ct = class ct {
  static getRawData() {
...
if (typeof Nn < "u" && typeof Nn.process < "u") {
  ...
  typeof process < "u" && typeof ((qa = process == null ? void 0 : process.versions) == null ? void 0 : qa.node) == "string" ? mt = {
    get platform() {
    ...
    // Supported
    get platform() {
      return It ? "win32" : Vo ? "darwin" : "linux";
    },
    get arch() {
    },
    // Unsupported
...
const en = mt.cwd, ol = mt.env, ll = mt.platform, ul = 65, cl = 97, hl = 90, dl = 122, Ge = 46, ae = 47, me = 92, Pe = 58, ml = 63;
...
function fl(e, t) {
  if (e === null || typeof e != "object")
    throw new Xa(t, "Object", e);
}
function ee(e, t) {
  if (typeof e != "string")
    throw new Xa(t, "string", e);
}
const We = ll === "win32";
function V(e) {
  return e === ae || e === me;
...
function tn(e, t, n, i) {
  ...
  for (let u = 0; u <= e.length; ++u) {
    ...
    if (i(o)) {
      if (!(a === u - 1 || l === 1))
        if (l === 2) {
          if (r.length < 2 || s !== 2 || r.charCodeAt(r.length - 1) !== Ge || r.charCodeAt(r.length - 2) !== Ge) {
            if (r.length > 2) {
...
function Ja(e, t) {
  fl(t, "pathObject");
  const n = t.dir || t.root, i = t.base || `${t.name || ""}${pl(t.ext)}`;
...
const ue = {
  ...
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (r >= 0) {
        ...
        t.length === 0 ? s = en() : (s = ol[`=${t}`] || en(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === me) && (s = `${t}\\`));
      const a = s.length;
      let l = 0, o = "", u = !1;
      ...
      if (a === 1)
        ...
        if (u = !0, V(s.charCodeAt(1))) {
          let d = 2, m = d;
          for (; d < a && !V(s.charCodeAt(d)); )
            d++;
          if (d < a && d !== m) {
            const f = s.slice(m, d);
            for (m = d; d < a && V(s.charCodeAt(d)); )
              d++;
            if (d < a && d !== m) {
              for (m = d; d < a && !V(s.charCodeAt(d)); )
                d++;
        ...
        Be(c) && s.charCodeAt(1) === Pe && (o = s.slice(0, 2), l = 2, a > 2 && V(s.charCodeAt(2)) && (u = !0, l = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (t === 1)
      return $n(s) ? "\\" : e;
    if (V(s))
      if (r = !0, V(e.charCodeAt(1))) {
        let l = 2, o = l;
        for (; l < t && !V(e.charCodeAt(l)); )
          l++;
        if (l < t && l !== o) {
          const u = e.slice(o, l);
          for (o = l; l < t && V(e.charCodeAt(l)); )
            l++;
          if (l < t && l !== o) {
            for (o = l; l < t && !V(e.charCodeAt(l)); )
              l++;
      ...
      Be(s) && e.charCodeAt(1) === Pe && (i = e.slice(0, 2), n = 2, t > 2 && V(e.charCodeAt(2)) && (r = !0, n = 3));
    let a = n < t ? tn(e.slice(n), !r, "\\", V) : "";
    return a.length === 0 && !r && (a = "."), a.length > 0 && V(e.charCodeAt(t - 1)) && (a += "\\"), i === void 0 ? r ? `\\${a}` : a : r ? `${i}\\${a}` : `${i}${a}`;
  },
  isAbsolute(e) {
    ee(e, "path");
    const t = e.length;
    ...
    t > 2 && Be(n) && e.charCodeAt(1) === Pe && V(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    if (typeof n == "string" && V(n.charCodeAt(0))) {
      ++r;
      const s = n.length;
      s > 1 && V(n.charCodeAt(1)) && (++r, s > 2 && (V(n.charCodeAt(2)) ? ++r : i = !1));
    }
    if (i) {
  ...
  relative(e, t) {
    ...
    if (m !== c) {
      ...
      a > c && (e.charCodeAt(r + m) === me ? d = m : m === 2 && (d = 3)), d === -1 && (d = 0);
    }
    let f = "";
    for (m = r + d + 1; m <= s; ++m)
      (m === s || e.charCodeAt(m) === me) && (f += f.length === 0 ? ".." : "\\..");
  ...
  toNamespacedPath(e) {
    ...
    } else if (Be(t.charCodeAt(0)) && t.charCodeAt(1) === Pe && t.charCodeAt(2) === me)
      return `\\\\?\\${t}`;
    return e;
  },
  dirname(e) {
    ...
    if (V(r)) {
      ...
      Be(r) && e.charCodeAt(1) === Pe && (n = t > 2 && V(e.charCodeAt(2)) ? 3 : 2, i = n);
    let s = -1, a = !0;
    for (let l = t - 1; l >= i; --l)
      if (V(e.charCodeAt(l))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, i = -1, r = !0, s;
    if (e.length >= 2 && Be(e.charCodeAt(0)) && e.charCodeAt(1) === Pe && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === Pe && Be(e.charCodeAt(0)) && (t = i = 2);
  ...
  parse(e) {
    ...
    if (n === 1)
      return V(r) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
    if (V(r)) {
      if (i = 1, V(e.charCodeAt(1))) {
        let d = 2, m = d;
        for (; d < n && !V(e.charCodeAt(d)); )
          d++;
        if (d < n && d !== m) {
          for (m = d; d < n && V(e.charCodeAt(d)); )
            d++;
          if (d < n && d !== m) {
            for (m = d; d < n && !V(e.charCodeAt(d)); )
              d++;
    ...
    } else if (Be(r) && e.charCodeAt(1) === Pe) {
      if (n <= 2)
        return t.root = t.dir = e, t;
      if (i = 2, V(e.charCodeAt(2))) {
        if (n === 3)
          return t.root = t.dir = e, t;
        i = 3;
      }
    ...
    for (; u >= i; --u) {
      ...
      l === -1 && (o = !1, l = u + 1), r === Ge ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
    return l !== -1 && (s === -1 || // We saw a non-dot character immediately before the dot
    c === 0 || // The (right-most) trimmed path component is exactly '..'
    c === 1 && s === l - 1 && s === a + 1 ? t.base = t.name = e.slice(a, l) : (t.name = e.slice(a, s), t.base = e.slice(a, l), t.ext = e.slice(s, l))), a > 0 && a !== i ? t.dir = e.slice(0, a - 1) : t.dir = t.root, t;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...e) {
    ...
    for (let i = e.length - 1; i >= -1 && !n; i--) {
      const r = i >= 0 ? e[i] : gl();
      ee(r, `paths[${i}]`), r.length !== 0 && (t = `${r}/${t}`, n = r.charCodeAt(0) === ae);
    }
    return t = tn(t, !n, "/", $n), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (ee(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ae, n = e.charCodeAt(e.length - 1) === ae;
    return e = tn(e, !t, "/", $n), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
    return ee(e, "path"), e.length > 0 && e.charCodeAt(0) === ae;
  },
  join(...e) {
    if (e.length === 0)
      return ".";
  ...
  relative(e, t) {
    if (ee(e, "from"), ee(t, "to"), e === t || (e = ce.resolve(e), t = ce.resolve(t), e === t))
      return "";
    ...
    if (u === l)
      if (a > l) {
        ...
        r > l && (e.charCodeAt(n + u) === ae ? o = u : u === 0 && (o = 0));
    let c = "";
    for (u = n + o + 1; u <= i; ++u)
      (u === i || e.charCodeAt(u) === ae) && (c += c.length === 0 ? ".." : "/..");
  ...
  parse(e) {
    ...
    for (; o >= i; --o) {
      ...
      a === -1 && (l = !1, a = o + 1), c === Ge ? r === -1 ? r = o : u !== 1 && (u = 1) : r !== -1 && (u = -1);
    }
    if (a !== -1) {
      const c = s === 0 && n ? 1 : s;
      r === -1 || // We saw a non-dot character immediately before the dot
      u === 0 || // The (right-most) trimmed path component is exactly '..'
      u === 1 && r === a - 1 && r === s + 1 ? t.base = t.name = e.slice(c, a) : (t.name = e.slice(c, r), t.base = e.slice(c, a), t.ext = e.slice(r, a));
    }
...
ce.win32 = ue.win32 = ue;
ce.posix = ue.posix = ce;
We ? ue.normalize : ce.normalize;
const bl = We ? ue.join : ce.join;
We ? ue.resolve : ce.resolve;
We ? ue.relative : ce.relative;
We ? ue.dirname : ce.dirname;
We ? ue.basename : ce.basename;
We ? ue.extname : ce.extname;
We ? ue.sep : ce.sep;
const _l = /^\w[\w\d+.-]*$/, wl = /^\//, vl = /^\/\//;
function yl(e, t) {
  if (!e.scheme && t)
    throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);
  if (e.scheme && !_l.test(e.scheme))
    throw new Error("[UriError]: Scheme contains illegal characters.");
  if (e.path) {
    if (e.authority) {
      if (!wl.test(e.path))
        throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
    } else if (vl.test(e.path))
...
let Re = class Ot {
  static isUri(t) {
    return t instanceof Ot ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1;
  }
  /**
   * @internal
   */
  constructor(t, n, i, r, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || Y, this.authority = t.authority || Y, this.path = t.path || Y, this.query = t.query || Y, this.fragment = t.fragment || Y) : (this.scheme = xl(t, a), this.authority = n || Y, this.path = Tl(this.scheme, i || Y), this.query = r || Y, this.fragment = s || Y, yl(this, a));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = Y), i === void 0 ? i = this.authority : i === null && (i = Y), r === void 0 ? r = this.path : r === null && (r = Y), s === void 0 ? s = this.query : s === null && (s = Y), a === void 0 ? a = this.fragment : a === null && (a = Y), n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment ? this : new tt(n, i, r, s, a);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(t, n = !1) {
    const i = kl.exec(t);
    return i ? new tt(i[2] || Y, Bt(i[4] || Y), Bt(i[5] || Y), Bt(i[7] || Y), Bt(i[9] || Y), n) : new tt(Y, Y, Y, Y, Y);
  }
  /**
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return It && t.scheme === "file" ? i = Ot.file(ue.join(Gn(t, !0), ...n)).path : i = ce.join(t.path, ...n), t.with({ path: i });
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new tt(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === Ya ? t.fsPath ?? null : null, n;
      }
    } else
      return t;
  }
};
const Ya = It ? 1 : void 0;
class tt extends Re {
  constructor() {
  ...
  toJSON() {
    ...
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = Ya), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const Qa = {
  58: "%3A",
...
function Al(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === 35 || i === 63 ? (t === void 0 && (t = e.substr(0, n)), t += Qa[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function Gn(e, t) {
...
function Za(e) {
  try {
    ...
    return e.length > 3 ? e.substr(0, 3) + Za(e.substr(3)) : e;
  }
}
const ji = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function Bt(e) {
  return e.match(ji) ? e.replace(ji, (t) => Za(t)) : e;
}
var je;
(function(e) {
...
class Ll {
  ...
  get _remoteResourcesPath() {
    return ce.join(this._serverRootPath, je.vscodeRemoteResource);
  }
  rewrite(t) {
    if (this._delegate)
      try {
    ...
    return typeof s == "string" && (a += `&${Sl}=${encodeURIComponent(s)}`), Re.from({
      scheme: $o ? this._preferredWebSchema : je.vscodeRemoteResource,
      authority: `${i}:${r}`,
...
const Cl = new Ll(), El = "vscode-app", Rt = class Rt {
  /**
   ...
   */
  uriToBrowserUri(t) {
    return t.scheme === je.vscodeRemote ? Cl.rewrite(t) : (
      // ...only ever for `file` resources
      t.scheme === je.file && // ...and we run in native environments
      (jo || // ...or web worker extensions on desktop
      Xo === `${je.vscodeFileResource}://${Rt.FALLBACK_AUTHORITY}`) ? t.with({
        scheme: je.vscodeFileResource,
        // We need to provide an authority here so that it can serve
        // as origin for network and loading matters in chromium.
        // If the URI is not coming with an authority already, we
        // add our own
        authority: t.authority || Rt.FALLBACK_AUTHORITY,
        query: null,
        fragment: null
      }) : t
    );
  ...
  toUri(t, n) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(i))
        return Re.joinPath(Re.parse(i, !0), t);
      const r = bl(i, t);
      return Re.file(r);
    }
...
(function(e) {
  ...
  function i(s) {
    let a;
    typeof s == "string" ? a = new URL(s).searchParams : s instanceof URL ? a = s.searchParams : Re.isUri(s) && (a = new URL(s.toString(!0)).searchParams);
...
const Dn = "default", Rl = "$initialize";
class Ml {
...
class zl {
  ...
  sendMessage(t, n, i) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: a
      }, this._send(new Ml(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
    const s = new ve({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new Nl(this._workerId, r, t, n, i));
      },
      onDidRemoveLastListener: () => {
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (to(s) ? r[s] = (a) => this.listen(t, s, a) : eo(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === 36 && (r[s] = async (...a) => (await (n == null ? void 0 : n()), this.sendMessage(t, s, a)))), r[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      this._send(new Gi(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = Fi(r.detail)), this._send(new Gi(this._workerId, n, void 0, Fi(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new Dl(this._workerId, n, r));
    });
...
function eo(e) {
  return e[0] === "o" && e[1] === "n" && $a(e.charCodeAt(2));
}
function to(e) {
  return /^onDynamic/.test(e) && $a(e.charCodeAt(9));
}
class Ul {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new zl({
      sendMessage: (i, r) => {
        t(i, r);
      },
  ...
  _handleMessage(t, n, i) {
    ...
    const r = t === Dn ? this._requestHandler : this._localChannels.get(t);
    if (!r)
  ...
  async initialize(t, n, i) {
    ...
    return n && (typeof n.baseUrl < "u" && delete n.baseUrl, typeof n.paths < "u" && typeof n.paths.vs < "u" && delete n.paths.vs, typeof n.trustedTypesPolicy < "u" && delete n.trustedTypesPolicy, n.catchError = !0, globalThis.require.config(n)), import(`${Ka.asBrowserUri(`${i}.js`).toString(!0)}`).then((s) => {
...
function Ji(e, t = 0, n = e.byteLength, i = 0) {
  for (let r = 0; r < n; r++)
    e[t + r] = i;
}
function Wl(e, t, n = "0") {
...
const xn = class xn {
  ...
  _push(t, n, i) {
    return i < 128 ? t[n++] = i : i < 2048 ? (t[n++] = 192 | (i & 1984) >>> 6, t[n++] = 128 | (i & 63) >>> 0) : i < 65536 ? (t[n++] = 224 | (i & 61440) >>> 12, t[n++] = 128 | (i & 4032) >>> 6, t[n++] = 128 | (i & 63) >>> 0) : (t[n++] = 240 | (i & 1835008) >>> 18, t[n++] = 128 | (i & 258048) >>> 12, t[n++] = 128 | (i & 4032) >>> 6, t[n++] = 128 | (i & 63) >>> 0), n >= 64 && (this._step(), n -= 64, this._totalLen += 64, t[0] = t[64], t[1] = t[65], t[2] = t[66]), n;
  }
  digest() {
    ...
    )), this._totalLen += this._buffLen, this._wrapUp()), vt(this._h0) + vt(this._h1) + vt(this._h2) + vt(this._h3) + vt(this._h4);
  }
  _wrapUp() {
    this._buff[this._buffLen++] = 128, Ji(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), Ji(this._buff));
  ...
  _step() {
    const t = xn._bigBlock32, n = this._buffDV;
    for (let d = 0; d < 64; d += 4)
      t.setUint32(d, n.getUint32(d, !1), !1);
    for (let d = 64; d < 320; d += 4)
      t.setUint32(d, In(t.getUint32(d - 12, !1) ^ t.getUint32(d - 32, !1) ^ t.getUint32(d - 56, !1) ^ t.getUint32(d - 64, !1), 1), !1);
    let i = this._h0, r = this._h1, s = this._h2, a = this._h3, l = this._h4, o, u, c;
    for (let d = 0; d < 80; d++)
      d < 20 ? (o = r & s | ~r & a, u = 1518500249) : d < 40 ? (o = r ^ s ^ a, u = 1859775393) : d < 60 ? (o = r & s | r & a | s & a, u = 2400959708) : (o = r ^ s ^ a, u = 3395469782), c = In(i, 5) + o + l + u + t.getUint32(d * 4, !1) & 4294967295, l = a, a = s, s = In(r, 30), r = i, i = c;
...
xn._bigBlock32 = new DataView(new ArrayBuffer(320));
let Yi = xn;
class Qi {
  constructor(t) {
    this.source = t;
...
function Fl(e, t, n) {
  return new Ve(new Qi(e), new Qi(t)).ComputeDiff(n).changes;
}
class nt {
  static Assert(t, n) {
    if (!t)
...
class Ve {
  ...
  constructor(t, n, i = null) {
    ...
    const [r, s, a] = Ve._getElements(t), [l, o, u] = Ve._getElements(n);
  ...
  WALKTRACE(t, n, i, r, s, a, l, o, u, c, d, m, f, _, g, k, y, v) {
    let C = null, M = null, D = new Zi(), N = n, b = i, p = f[0] - k[0] - r, x = -1073741824, U = this.m_forwardHistory.length - 1;
    do {
      const L = p + t;
      L === N || L < b && u[L - 1] < u[L + 1] ? (d = u[L + 1], _ = d - p - r, d < x && D.MarkNextChange(), x = d, D.AddModifiedElement(d + 1, _), p = L + 1 - t) : (d = u[L - 1] + 1, _ = d - p - r, d < x && D.MarkNextChange(), x = d - 1, D.AddOriginalElement(d, _ + 1), p = L - 1 - t), U >= 0 && (u = this.m_forwardHistory[U], t = u[0], N = 1, b = u.length - 1);
    } while (--U >= -1);
    if (C = D.getReverseChanges(), v[0]) {
      let L = f[0] + 1, T = k[0] + 1;
      if (C !== null && C.length > 0) {
        const S = C[C.length - 1];
        L = Math.max(L, S.getOriginalEnd()), T = Math.max(T, S.getModifiedEnd());
      }
      M = [
        new qe(L, m - L + 1, T, g - T + 1)
      ];
    } else {
      D = new Zi(), N = a, b = l, p = f[0] - k[0] - o, x = 1073741824, U = y ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const L = p + s;
        L === N || L < b && c[L - 1] >= c[L + 1] ? (d = c[L + 1] - 1, _ = d - p - o, d > x && D.MarkNextChange(), x = d + 1, D.AddOriginalElement(d + 1, _ + 1), p = L + 1 - s) : (d = c[L - 1], _ = d - p - o, d > x && D.MarkNextChange(), x = d, D.AddModifiedElement(d + 1, _ + 1), p = L - 1 - s), U >= 0 && (c = this.m_reverseHistory[U], s = c[0], N = 1, b = c.length - 1);
      } while (--U >= -1);
      M = D.getChanges();
    }
    return this.ConcatenateChanges(C, M);
  }
  /**
  ...
  ComputeRecursionPoint(t, n, i, r, s, a, l) {
    ...
    const _ = n - t + (r - i), g = _ + 1, k = new Int32Array(g), y = new Int32Array(g), v = r - i, C = n - t, M = t - i, D = n - r, b = (C - v) % 2 === 0;
    k[v] = t, y[C] = n, l[0] = !1;
    for (let p = 1; p <= _ / 2 + 1; p++) {
      let x = 0, U = 0;
      c = this.ClipDiagonalBound(v - p, p, v, g), d = this.ClipDiagonalBound(v + p, p, v, g);
      for (let T = c; T <= d; T += 2) {
        T === c || T < d && k[T - 1] < k[T + 1] ? o = k[T + 1] : o = k[T - 1] + 1, u = o - (T - v) - M;
        const S = o;
        for (; o < n && u < r && this.ElementsAreEqual(o + 1, u + 1); )
          o++, u++;
        if (k[T] = o, o + u > x + U && (x = o, U = u), !b && Math.abs(T - C) <= p - 1 && o >= y[T])
          return s[0] = o, a[0] = u, S <= y[T] && 1447 > 0 && p <= 1448 ? this.WALKTRACE(v, c, d, M, C, m, f, D, k, y, o, n, s, u, r, a, b, l) : null;
      }
      const L = (x - t + (U - i) - p) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(x, L))
        return l[0] = !0, s[0] = x, a[0] = U, L > 0 && 1447 > 0 && p <= 1448 ? this.WALKTRACE(v, c, d, M, C, m, f, D, k, y, o, n, s, u, r, a, b, l) : (t++, i++, [
          new qe(t, n - t + 1, i, r - i + 1)
        ]);
      m = this.ClipDiagonalBound(C - p, p, C, g), f = this.ClipDiagonalBound(C + p, p, C, g);
      for (let T = m; T <= f; T += 2) {
        T === m || T < f && y[T - 1] >= y[T + 1] ? o = y[T + 1] - 1 : o = y[T - 1], u = o - (T - C) - D;
        const S = o;
        for (; o > t && u > i && this.ElementsAreEqual(o, u); )
          o--, u--;
        if (y[T] = o, b && Math.abs(T - v) <= p && o <= k[T])
          return s[0] = o, a[0] = u, S >= k[T] && 1447 > 0 && p <= 1448 ? this.WALKTRACE(v, c, d, M, C, m, f, D, k, y, o, n, s, u, r, a, b, l) : null;
      }
      if (p <= 1447) {
        let T = new Int32Array(d - c + 2);
        T[0] = v - c + 1, it.Copy2(k, c, T, 1, d - c + 1), this.m_forwardHistory.push(T), T = new Int32Array(f - m + 2), T[0] = C - m + 1, it.Copy2(y, m, T, 1, f - m + 1), this.m_reverseHistory.push(T);
      }
    }
    return this.WALKTRACE(v, c, d, M, C, m, f, D, k, y, o, n, s, u, r, a, b, l);
  }
  /**
  ...
  PrettifyChanges(t) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      for (let d = 1; ; d++) {
        ...
        if (m < r || f < s || a && !this.OriginalElementsAreEqual(m, m + i.originalLength) || l && !this.ModifiedElementsAreEqual(f, f + i.modifiedLength))
          break;
    ...
    if (this._hasStrings)
      for (let n = 1, i = t.length; n < i; n++) {
        ...
        if (a < 5 && u < 20 && m < 20) {
          ...
          if (f) {
            const [_, g] = f;
            (_ !== r.originalStart + r.originalLength || g !== r.modifiedStart + r.modifiedLength) && (r.originalLength = _ - r.originalStart, r.modifiedLength = g - r.modifiedStart, s.originalStart = _ + a, s.modifiedStart = g + a, s.originalLength = o - s.originalStart, s.modifiedLength = d - s.modifiedStart);
          }
        }
      }
    return t;
  ...
  ChangesOverlap(t, n, i) {
    if (nt.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), nt.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), i[0] = new qe(r, s, a, l), !0;
    } else
      return i[0] = null, !1;
  }
  /**
...
let te = class Ye {
  ...
  static intersectRanges(t, n) {
    ...
    return i < l ? (i = l, r = o) : i === l && (r = Math.max(r, o)), s > u ? (s = u, a = c) : s === u && (a = Math.min(a, c)), i > s || i === s && r > a ? null : new ne(i, r, s, a);
  }
  /**
...
class nn {
  ...
  static computeLinks(t, n = ql()) {
    ...
    for (let s = 1, a = t.getLineCount(); s <= a; s++) {
      ...
      let u = 0, c = 0, d = 0, m = 1, f = !1, _ = !1, g = !1, k = !1;
      for (; u < o; ) {
        let y = !1;
        ...
        if (m === 13) {
          ...
          switch (v) {
            ...
            case 34:
            case 96:
              d === v ? C = 1 : d === 39 || d === 34 || d === 96 ? C = 0 : C = 1;
              break;
            case 42:
              C = d === 42 ? 1 : 0;
              break;
          ...
          C === 1 && (r.push(nn._createLink(i, l, s, c, u)), y = !0);
        } else if (m === 12) {
          let C;
          v === 91 ? (_ = !0, C = 0) : C = i.get(v), C === 1 ? y = !0 : m = 13;
        } else
          m = n.nextState(m, v), m === 0 && (y = !0);
        y && (m = 1, f = !1, _ = !1, k = !1, c = u + 1, d = v), u++;
      }
      m === 13 && r.push(nn._createLink(i, l, s, c, o));
    }
    return r;
  }
}
function Vl(e) {
  return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : nn.computeLinks(e);
}
const Tn = class Tn {
  constructor() {
...
Tn.INSTANCE = new Tn();
let Yn = Tn;
const no = Object.freeze(function(e, t) {
...
class Vt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? no : (this._emitter || (this._emitter = new ve()), this._emitter.event);
  }
  dispose() {
...
class jl {
  ...
  cancel() {
    this._token ? this._token instanceof Vt && this._token.cancel() : this._token = rn.Cancelled;
  }
  dispose(t = !1) {
    var n;
    t && this.cancel(), (n = this._parentListener) == null || n.dispose(), this._token ? this._token instanceof Vt && this._token.dispose() : this._token = rn.None;
  }
}
class zi {
  constructor() {
...
const jt = new zi(), Qn = new zi(), Zn = new zi(), $l = new Array(230), Gl = /* @__PURE__ */ Object.create(null), Xl = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    ...
    if (i[a] || (i[a] = !0, Gl[l] = a, Xl[l.toLowerCase()] = a), !n[o]) {
      if (n[o] = !0, !u)
        throw new Error(`String representation missing for key code ${o} around scan code ${l}`);
      jt.define(o, u), Qn.define(o, m || u), Zn.define(o, f || m || u);
    }
    c && ($l[c] = o);
  }
})();
...
class io {
  ...
  register(t, n) {
    return this._tokenizationSupports.set(t, n), this.handleChange([t]), Qt(() => {
  ...
  registerFactory(t, n) {
    ...
    const i = new Kl(this, t, n);
    return this._factories.set(t, i), Qt(() => {
...
(function(e) {
  ...
  function n(i) {
    let r = t.get(i);
    return r || (console.info("No codicon found for SymbolKind " + i), r = P.symbolProperty), r;
  }
  e.toIcon = n;
})(lr || (lr = {}));
var pe;
...
const Ze = class Ze {
  constructor(t, n) {
    if (this[ns] = "ResourceMap", t instanceof Ze)
      this.map = new Map(t.map), this.toKey = n ?? Ze.defaultToKey;
    else if (iu(t)) {
      this.map = /* @__PURE__ */ new Map(), this.toKey = n ?? Ze.defaultToKey;
      for (const [i, r] of t)
        this.set(i, r);
    } else
      this.map = /* @__PURE__ */ new Map(), this.toKey = t ?? Ze.defaultToKey;
  }
  set(t, n) {
  ...
  *[(ns = Symbol.toStringTag, Symbol.iterator)]() {
    for (const [, t] of this.map)
      yield [t.uri, t.value];
  }
};
Ze.defaultToKey = (t) => t.toString();
let rs = Ze;
class ru {
  constructor() {
...
function du(e, t, n, i, r) {
  return cu(e, t, n, i, r) && hu(e, t, n, i, r);
}
class mu {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          il(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || du(this._wordSeparators, t, n, r, s))
        return i;
    } while (i);
    return null;
  }
}
function fu(e, t = "Unreachable") {
  throw new Error(t);
}
function sn(e) {
  if (!e()) {
    debugger;
    e(), At(new we("Assertion Failed"));
  }
}
function ro(e, t) {
  let n = 0;
...
function Ui(e, t, n, i, r) {
  if (t = ao(t), r || (r = Yt.first(oo)), n.length > r.maxLen) {
    let u = e - r.maxLen / 2;
...
class _u {
  static computeUnicodeHighlights(t, n, i) {
    const r = i ? i.startLineNumber : 1, s = i ? i.endLineNumber : t.getLineCount(), a = new us(n), l = a.getCandidateCodePoints();
    let o;
    l === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${wu(Array.from(l))}`, "g");
    const u = new mu(null, o), c = [];
    let d = !1, m, f = 0, _ = 0, g = 0;
    e:
      for (let k = r, y = s; k <= y; k++) {
        const v = t.getLineContent(k), C = v.length;
        u.reset(0);
        do
          if (m = u.next(v), m) {
            let M = m.index, D = m.index + m[0].length;
            if (M > 0) {
              const x = v.charCodeAt(M - 1);
              Kt(x) && M--;
            }
            if (D + 1 < C) {
              const x = v.charCodeAt(D - 1);
              Kt(x) && D++;
            }
            const N = v.substring(M, D);
            let b = Ui(M + 1, so, v, 0);
            b && b.endColumn <= M + 1 && (b = null);
            const p = a.shouldHighlightNonBasicASCII(N, b ? b.word : null);
            if (p !== 0) {
              if (p === 3 ? f++ : p === 2 ? _++ : p === 1 ? g++ : fu(), c.length >= 1e3) {
                d = !0;
                break e;
              }
              c.push(new G(k, M + 1, k, D + 1));
            }
          }
        while (m);
      }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const s = t.codePointAt(0), a = i.ambiguousCharacters.getPrimaryConfusable(s), l = zt.getLocales().filter((o) => !zt.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, o])).isAmbiguous(s));
...
function wu(e, t) {
  return `[${Ko(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
}
class us {
  constructor(t) {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of St.codePoints)
        cs(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const l = a.codePointAt(0), o = sl(a);
        r = r || o, !o && !this.ambiguousCharacters.isAmbiguous(l) && !St.isInvisibleCharacter(l) && (s = !0);
      }
    return (
      /* Don't allow mixing weird looking characters with ASCII */
      !r && /* Is there an obviously weird looking character? */
      s ? 0 : this.options.invisibleCharacters && !cs(t) && St.isInvisibleCharacter(i) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? 3 : 0
    );
  }
}
function cs(e) {
...
function Ut(e, t, n = 0, i = e.length) {
  let r = n, s = i;
  for (; r < s; ) {
...
function si(e, t, n = 0, i = e.length) {
  let r = n, s = i;
  for (; r < s; ) {
    const a = Math.floor((r + s) / 2);
    t(e[a]) ? s = a : r = a + 1;
...
class O {
   ...
   */
  join(t) {
    return new O(Math.min(this.startLineNumber, t.startLineNumber), Math.max(this.endLineNumberExclusive, t.endLineNumberExclusive));
  }
  toString() {
    return `[${this.startLineNumber},${this.endLineNumberExclusive})`;
  }
...
class Me {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = si(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = Ut(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  getUnion(t) {
    ...
    for (; i < this._normalizedRanges.length || r < t._normalizedRanges.length; ) {
      ...
      if (i < this._normalizedRanges.length && r < t._normalizedRanges.length) {
        ...
        i < this._normalizedRanges.length ? (a = this._normalizedRanges[i], i++) : (a = t._normalizedRanges[r], r++);
      s === null ? s = a : s.endLineNumberExclusive >= a.startLineNumber ? s = new O(s.startLineNumber, Math.max(s.endLineNumberExclusive, a.endLineNumberExclusive)) : (n.push(s), s = a);
    }
   ...
   */
  subtractFrom(t) {
    const n = si(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), i = Ut(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Me([t]);
    const r = [];
    ...
    for (let a = n; a < i; a++) {
      ...
      l.startLineNumber > s && r.push(new O(s, l.startLineNumber)), s = l.endLineNumberExclusive;
    }
    return s < t.endLineNumberExclusive && r.push(new O(s, t.endLineNumberExclusive)), new Me(r);
  }
  toString() {
...
` ? (n++, i = 0) : i++;
  ...
  createRange(t) {
    return this.lineCount === 0 ? new G(t.lineNumber, t.column, t.lineNumber, t.column + this.columnCount) : new G(t.lineNumber, t.column, t.lineNumber + this.lineCount, this.columnCount + 1);
  }
  addToPosition(t) {
...
class xe {
  static inverse(t, n, i) {
    ...
    let s = 1, a = 1;
    for (const o of t) {
      const u = new xe(new O(s, o.original.startLineNumber), new O(a, o.modified.startLineNumber));
      u.modified.isEmpty || r.push(u), s = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
    }
    const l = new xe(new O(s, n + 1), new O(a, i + 1));
  ...
  static clip(t, n, i) {
    ...
    for (const s of t) {
      ...
      a && !a.isEmpty && l && !l.isEmpty && r.push(new xe(a, l));
    }
    return r;
  }
  constructor(t, n) {
  ...
  */
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new Le(new G(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new G(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new Le(new G(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new G(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
  }
  /**
   * This method assumes that the LineRangeMapping describes a valid diff!
   * I.e. if one range is empty, the other range cannot be the entire document.
  ...
  */
  toRangeMapping2(t, n) {
    if (ds(this.original.endLineNumberExclusive, t) && ds(this.modified.endLineNumberExclusive, n))
      return new Le(new G(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new G(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new Le(G.fromPositions(new te(this.original.startLineNumber, 1), st(new te(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), G.fromPositions(new te(this.modified.startLineNumber, 1), st(new te(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new Le(G.fromPositions(st(new te(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), st(new te(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), G.fromPositions(st(new te(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), st(new te(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new we();
  }
}
function st(e, t) {
...
class Ue extends xe {
  static fromRangeMappings(t) {
    const n = O.join(t.map((r) => O.fromRangeInclusive(r.originalRange))), i = O.join(t.map((r) => O.fromRangeInclusive(r.modifiedRange)));
    return new Ue(n, i, t);
  }
  constructor(t, n, i) {
...
class Le {
  ...
  */
  toTextEdit(t) {
    ...
    return new xu(this.originalRange, n);
  }
}
const Tu = 3;
class ku {
  computeDiff(t, n, i) {
    ...
    for (const u of s.changes) {
      let c;
      u.originalEndLineNumber === 0 ? c = new O(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1) : c = new O(u.originalStartLineNumber, u.originalEndLineNumber + 1);
      let d;
      u.modifiedEndLineNumber === 0 ? d = new O(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1) : d = new O(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1);
      let m = new Ue(c, d, (o = u.charChanges) == null ? void 0 : o.map((f) => new Le(new G(f.originalStartLineNumber, f.originalStartColumn, f.originalEndLineNumber, f.originalEndColumn), new G(f.modifiedStartLineNumber, f.modifiedStartColumn, f.modifiedEndLineNumber, f.modifiedEndColumn))));
      l && (l.modified.endLineNumberExclusive === m.modified.startLineNumber || l.original.endLineNumberExclusive === m.original.startLineNumber) && (m = new Ue(l.original.join(m.original), l.modified.join(m.modified), l.innerChanges && m.innerChanges ? l.innerChanges.concat(m.innerChanges) : void 0), a.pop()), a.push(m), l = m;
    }
    return sn(() => ro(a, (u, c) => c.original.startLineNumber - u.original.endLineNumberExclusive === c.modified.startLineNumber - u.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    u.original.endLineNumberExclusive < c.original.startLineNumber && u.modified.endLineNumberExclusive < c.modified.startLineNumber)), new $t(a, [], s.quitEarly);
  }
}
function lo(e, t, n, i) {
...
function Su(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    ...
    Math.min(a, l) < Tu ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class Lt {
  ...
  static createFromDiffResult(t, n, i, r, s, a, l) {
    ...
    if (n.originalLength === 0 ? (o = i.getStartLineNumber(n.originalStart) - 1, u = 0) : (o = i.getStartLineNumber(n.originalStart), u = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (c = r.getStartLineNumber(n.modifiedStart) - 1, d = 0) : (c = r.getStartLineNumber(n.modifiedStart), d = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
      const f = i.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1), _ = r.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
      if (f.getElements().length > 0 && _.getElements().length > 0) {
        let g = lo(f, _, s, !0).changes;
        l && (g = Su(g)), m = [];
        for (let k = 0, y = g.length; k < y; k++)
          m.push(ft.createFromDiffChange(g[k], f, _));
      }
    }
    return new Lt(o, u, c, d, m);
  }
}
class Lu {
  constructor(t, n, i) {
    this.shouldComputeCharChanges = i.shouldComputeCharChanges, this.shouldPostProcessCharChanges = i.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = i.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = i.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new ms(t), this.modified = new ms(n), this.continueLineDiff = fs(i.maxComputationTime), this.continueCharDiff = fs(i.maxComputationTime === 0 ? 0 : Math.min(i.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = lo(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let o = 0, u = n.length; o < u; o++)
        l.push(Lt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[o], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: i,
        changes: l
      };
    ...
    for (let l = -1, o = n.length; l < o; l++) {
      ...
      for (; s < c && a < d; ) {
        ...
        if (m !== f) {
          {
            let _ = ai(m, 1), g = ai(f, 1);
            for (; _ > 1 && g > 1; ) {
              const k = m.charCodeAt(_ - 2), y = f.charCodeAt(g - 2);
              if (k !== y)
                break;
              _--, g--;
            }
            (_ > 1 || g > 1) && this._pushTrimWhitespaceCharChange(r, s + 1, 1, _, a + 1, 1, g);
          }
          {
            let _ = oi(m, 1), g = oi(f, 1);
            const k = m.length + 1, y = f.length + 1;
            for (; _ < k && g < y; ) {
              const v = m.charCodeAt(_ - 1), C = m.charCodeAt(g - 1);
              if (v !== C)
                break;
              _++, g++;
            }
            (_ < k || g < y) && this._pushTrimWhitespaceCharChange(r, s + 1, _, k, a + 1, g, y);
          }
        }
        s++, a++;
      }
      u && (r.push(Lt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += u.originalLength, a += u.modifiedLength);
    }
    return {
      quitEarly: i,
      changes: r
  ...
  _pushTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new ft(n, i, n, r, s, a, s, l)]), t.push(new Lt(n, n, s, s, o));
  }
  _mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
    ...
    if (o === 0)
      return !1;
    const u = t[o - 1];
    return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new ft(n, i, n, r, s, a, s, l)), !0) : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = s, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new ft(n, i, n, r, s, a, s, l)), !0) : !1;
  }
}
function ai(e, t) {
  const n = tl(e);
...
const dt = class dt {
  ...
  filter(t) {
    return new dt((n) => this.iterate((i) => t(i) ? n(i) : !0));
  }
  map(t) {
    return new dt((n) => this.iterate((i) => n(t(i))));
  }
  findLast(t) {
    let n;
  ...
  findLastMaxBy(t) {
    let n, i = !0;
    return this.iterate((r) => ((i || li.isGreaterThan(t(r, n))) && (i = !1, n = r), !0)), n;
  }
};
dt.empty = new dt((t) => {
});
...
class He {
  static trivial(t, n) {
    return new He([new K(j.ofLength(t.length), j.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new He([new K(j.ofLength(t.length), j.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class K {
  static invert(t, n) {
    const i = [];
    return Ru(t, (r, s) => {
      i.push(K.fromOffsetPairs(r ? r.getEndExclusives() : De.zero, s ? s.getStarts() : new De(n, (r ? r.seq2Range.endExclusive - r.seq1Range.endExclusive : 0) + n)));
    }), i;
  }
...
Nt.chrKeys = /* @__PURE__ */ new Map();
let on = Nt;
class zu {
  compute(t, n, i = Ht.instance, r) {
    if (t.length === 0 || n.length === 0)
      return He.trivial(t, n);
    const s = new Un(t.length, n.length), a = new Un(t.length, n.length), l = new Un(t.length, n.length);
    for (let _ = 0; _ < t.length; _++)
      for (let g = 0; g < n.length; g++) {
        if (!i.isValid())
          return He.trivialTimedOut(t, n);
        const k = _ === 0 ? 0 : s.get(_ - 1, g), y = g === 0 ? 0 : s.get(_, g - 1);
        let v;
        t.getElement(_) === n.getElement(g) ? (_ === 0 || g === 0 ? v = 0 : v = s.get(_ - 1, g - 1), _ > 0 && g > 0 && a.get(_ - 1, g - 1) === 3 && (v += l.get(_ - 1, g - 1)), v += r ? r(_, g) : 1) : v = -1;
        const C = Math.max(k, y, v);
        if (C === v) {
          const M = _ > 0 && g > 0 ? l.get(_ - 1, g - 1) : 0;
          l.set(_, g, M + 1), a.set(_, g, 3);
        } else
          C === k ? (l.set(_, g, 0), a.set(_, g, 1)) : C === y && (l.set(_, g, 0), a.set(_, g, 2));
        s.set(_, g, C);
      }
    const o = [];
    let u = t.length, c = n.length;
    function d(_, g) {
      (_ + 1 !== u || g + 1 !== c) && o.push(new K(new j(_ + 1, u), new j(g + 1, c))), u = _, c = g;
    }
    let m = t.length - 1, f = n.length - 1;
    for (; m >= 0 && f >= 0; )
      a.get(m, f) === 3 ? (d(m, f), m--, f--) : a.get(m, f) === 1 ? m-- : f--;
    return d(-1, -1), o.reverse(), new He(o, !1);
  }
}
class uo {
  compute(t, n, i = Ht.instance) {
    ...
    e:
      for (; ; ) {
        ...
        const g = -Math.min(l, s.length + l % 2), k = Math.min(l, r.length + l % 2);
        for (c = g; c <= k; c += 2) {
          const y = c === k ? -1 : o.get(c + 1), v = c === g ? -1 : o.get(c - 1) + 1, C = Math.min(Math.max(y, v), r.length), M = C - c;
          if (C > r.length || M > s.length)
            continue;
          const D = a(C, M);
          o.set(c, D);
          const N = C === y ? u.get(c + 1) : u.get(c - 1);
          if (u.set(c, D !== C ? new gs(N, C, M, D - C) : N), o.get(c) === r.length && o.get(c) - c === s.length)
            break e;
        }
      }
    let d = u.get(c);
    const m = [];
    let f = r.length, _ = s.length;
    for (; ; ) {
      const g = d ? d.x + d.length : 0, k = d ? d.y + d.length : 0;
      if ((g !== f || k !== _) && m.push(new K(new j(g, f), new j(k, _))), !d)
        break;
      f = d.x, _ = d.y, d = d.prev;
    }
...
class ln {
  ...
  getBoundaryScore(t) {
    const n = _s(t > 0 ? this.elements[t - 1] : -1), i = _s(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && i === 8)
      return 0;
    if (n === 8)
      return 150;
  ...
  translateOffset(t, n = "right") {
    const i = Ut(this.firstElementOffsetByLineIdx, (s) => s <= t), r = t - this.firstElementOffsetByLineIdx[i];
    return new te(this.range.startLineNumber + i, 1 + this.lineStartOffsets[i] + r + (r === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[i]));
  }
  translateRange(t) {
    const n = this.translateOffset(t.start, "right"), i = this.translateOffset(t.endExclusive, "left");
    return i.isBefore(n) ? G.fromPositions(i, i) : G.fromPositions(n, i);
  }
  /**
   * Finds the word that contains the character at the given offset
   */
  findWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !Hn(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && Hn(this.elements[n - 1]); )
      n--;
    let i = t;
    for (; i < this.elements.length && Hn(this.elements[i]); )
      i++;
    return new j(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = bt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = yu(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new j(n, i);
  }
}
function Hn(e) {
...
function _s(e) {
  return e === 10 ? 8 : e === 13 ? 7 : ui(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
}
function Fu(e, t, n, i, r, s) {
  let { moves: a, excludedChanges: l } = Bu(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((c) => !l.has(c)), u = qu(o, i, r, t, n, s);
  return Nu(a, u), a = Ou(a), a = a.filter((c) => {
...
function Bu(e, t, n, i) {
  const r = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new on(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new on(o.modified, n, o))), l = /* @__PURE__ */ new Set();
  for (const o of s) {
    let u = -1, c;
    for (const d of a) {
    ...
    if (u > 0.9 && c && (a.delete(c), r.push(new xe(o.range, c.range)), l.add(o.source), l.add(c.source)), !i.isValid())
...
function qu(e, t, n, i, r, s) {
  ...
  for (const m of e)
    for (let f = m.original.startLineNumber; f < m.original.endLineNumberExclusive - 2; f++) {
      const _ = `${t[f - 1]}:${t[f + 1 - 1]}:${t[f + 2 - 1]}`;
      l.add(_, { range: new O(f, f + 3) });
    }
  const o = [];
  e.sort(Gt((m) => m.modified.startLineNumber, Xt));
  for (const m of e) {
    let f = [];
    for (let _ = m.modified.startLineNumber; _ < m.modified.endLineNumberExclusive - 2; _++) {
      const g = `${n[_ - 1]}:${n[_ + 1 - 1]}:${n[_ + 2 - 1]}`, k = new O(_, _ + 3), y = [];
      l.forEach(g, ({ range: v }) => {
        for (const M of f)
          if (M.originalLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive && M.modifiedLineRange.endLineNumberExclusive + 1 === k.endLineNumberExclusive) {
            M.originalLineRange = new O(M.originalLineRange.startLineNumber, v.endLineNumberExclusive), M.modifiedLineRange = new O(M.modifiedLineRange.startLineNumber, k.endLineNumberExclusive), y.push(M);
            return;
          }
        const C = {
          modifiedLineRange: k,
  ...
  o.sort(Du(Gt((m) => m.modifiedLineRange.length, Xt)));
  const u = new Me(), c = new Me();
  for (const m of o) {
    const f = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber, _ = u.subtractFrom(m.modifiedLineRange), g = c.subtractFrom(m.originalLineRange).getWithDelta(f), k = _.getIntersection(g);
    for (const y of k.ranges) {
      if (y.length < 3)
        continue;
      const v = y, C = y.delta(-f);
      a.push(new xe(C, v)), u.addRange(v), c.addRange(C);
    }
  }
  a.sort(Gt((m) => m.original.startLineNumber, Xt));
  const d = new an(e);
  for (let m = 0; m < a.length; m++) {
    const f = a[m], _ = d.findLastMonotonous((N) => N.original.startLineNumber <= f.original.startLineNumber), g = bt(e, (N) => N.modified.startLineNumber <= f.modified.startLineNumber), k = Math.max(f.original.startLineNumber - _.original.startLineNumber, f.modified.startLineNumber - g.modified.startLineNumber), y = d.findLastMonotonous((N) => N.original.startLineNumber < f.original.endLineNumberExclusive), v = bt(e, (N) => N.modified.startLineNumber < f.modified.endLineNumberExclusive), C = Math.max(y.original.endLineNumberExclusive - f.original.endLineNumberExclusive, v.modified.endLineNumberExclusive - f.modified.endLineNumberExclusive);
    let M;
    for (M = 0; M < k; M++) {
      const N = f.original.startLineNumber - M - 1, b = f.modified.startLineNumber - M - 1;
      if (N > i.length || b > r.length || u.contains(b) || c.contains(N) || !ws(i[N - 1], r[b - 1], s))
        break;
    }
    M > 0 && (c.addRange(new O(f.original.startLineNumber - M, f.original.startLineNumber)), u.addRange(new O(f.modified.startLineNumber - M, f.modified.startLineNumber)));
    let D;
    for (D = 0; D < C; D++) {
      const N = f.original.endLineNumberExclusive + D, b = f.modified.endLineNumberExclusive + D;
      if (N > i.length || b > r.length || u.contains(b) || c.contains(N) || !ws(i[N - 1], r[b - 1], s))
        break;
    }
    D > 0 && (c.addRange(new O(f.original.endLineNumberExclusive, f.original.endLineNumberExclusive + D)), u.addRange(new O(f.modified.endLineNumberExclusive, f.modified.endLineNumberExclusive + D))), (M > 0 || D > 0) && (a[m] = new xe(new O(f.original.startLineNumber - M, f.original.endLineNumberExclusive + D), new O(f.modified.startLineNumber - M, f.modified.endLineNumberExclusive + D)));
  }
  return a;
}
function ws(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new uo().compute(new ln([e], new G(1, 1, 1, e.length), !1), new ln([t], new G(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function Ou(e) {
  if (e.length === 0)
    return e;
  e.sort(Gt((n) => n.original.startLineNumber, Xt));
  const t = [e[0]];
...
function Vu(e, t) {
  const n = new an(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((l) => l.original.startLineNumber < i.original.endLineNumberExclusive) || new xe(new O(1, 1), new O(1, 1)), s = bt(e, (l) => l.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== s;
  }), t;
}
function vs(e, t, n) {
  let i = n;
  return i = ys(e, t, i), i = ys(e, t, i), i = ju(e, t, i), i;
}
function ys(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let s = 1; s < n.length; s++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (u = 1; u <= o && !(e.getElement(l.seq1Range.start - u) !== e.getElement(l.seq1Range.endExclusive - u) || t.getElement(l.seq2Range.start - u) !== t.getElement(l.seq2Range.endExclusive - u)); u++)
        ;
      if (u--, u === o) {
        i[i.length - 1] = new K(new j(a.seq1Range.start, l.seq1Range.endExclusive - o), new j(a.seq2Range.start, l.seq2Range.endExclusive - o));
        continue;
      }
      l = l.delta(-u);
    }
  ...
  for (let s = 0; s < i.length - 1; s++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (u = 0; u < o && !(!e.isStronglyEqual(l.seq1Range.start + u, l.seq1Range.endExclusive + u) || !t.isStronglyEqual(l.seq2Range.start + u, l.seq2Range.endExclusive + u)); u++)
        ;
      if (u === o) {
        i[s + 1] = new K(new j(l.seq1Range.start + o, a.seq1Range.endExclusive), new j(l.seq2Range.start + o, a.seq2Range.endExclusive));
        continue;
      }
      u > 0 && (l = l.delta(u));
    }
...
function ju(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    const r = i > 0 ? n[i - 1] : void 0, s = n[i], a = i + 1 < n.length ? n[i + 1] : void 0, l = new j(r ? r.seq1Range.endExclusive + 1 : 0, a ? a.seq1Range.start - 1 : e.length), o = new j(r ? r.seq2Range.endExclusive + 1 : 0, a ? a.seq2Range.start - 1 : t.length);
    s.seq1Range.isEmpty ? n[i] = xs(s, e, t, l, o) : s.seq2Range.isEmpty && (n[i] = xs(s.swap(), t, e, o, l).swap());
  }
  return n;
}
function xs(e, t, n, i, r) {
  ...
  let o = 0, u = -1;
  for (let c = -a; c <= l; c++) {
    const d = e.seq2Range.start + c, m = e.seq2Range.endExclusive + c, f = e.seq1Range.start + c, _ = t.getBoundaryScore(f) + n.getBoundaryScore(d) + n.getBoundaryScore(m);
    _ > u && (u = _, o = c);
  }
  return e.delta(o);
}
...
function Gu(e, t, n) {
  ...
  function a(o, u) {
    if (o.offset1 < s.offset1 || o.offset2 < s.offset2)
      return;
    const c = e.findWordContaining(o.offset1), d = t.findWordContaining(o.offset2);
    if (!c || !d)
      return;
    let m = new K(c, d);
    const f = m.intersect(u);
    let _ = f.seq1Range.length, g = f.seq2Range.length;
    for (; i.length > 0; ) {
      const k = i[0];
      if (!(k.seq1Range.intersects(m.seq1Range) || k.seq2Range.intersects(m.seq2Range)))
        break;
      const v = e.findWordContaining(k.seq1Range.start), C = t.findWordContaining(k.seq2Range.start), M = new K(v, C), D = M.intersect(k);
      if (_ += D.seq1Range.length, g += D.seq2Range.length, m = m.join(M), m.seq1Range.endExclusive >= k.seq1Range.endExclusive)
        i.shift();
      else
        break;
    }
    _ + g < (m.seq1Range.length + m.seq2Range.length) * 2 / 3 && r.push(m), s = m.getEndExclusives();
  }
  for (; i.length > 0; ) {
    const o = i.shift();
...
function Ju(e, t, n) {
  ...
  do {
    ...
    for (let o = 1; o < i.length; o++) {
      let d = function(f, _) {
        const g = new j(c.seq1Range.endExclusive, u.seq1Range.start);
        return e.getText(g).replace(/\s/g, "").length <= 4 && (f.seq1Range.length + f.seq2Range.length > 5 || _.seq1Range.length + _.seq2Range.length > 5);
      };
      var a = d;
...
function Yu(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < i.length; u++) {
      let m = function(_, g) {
        const k = new j(d.seq1Range.endExclusive, c.seq1Range.start);
        if (e.countLinesIn(k) > 5 || k.length > 500)
          return !1;
        const v = e.getText(k).trim();
        if (v.length > 20 || v.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const C = e.countLinesIn(_.seq1Range), M = _.seq1Range.length, D = t.countLinesIn(_.seq2Range), N = _.seq2Range.length, b = e.countLinesIn(g.seq1Range), p = g.seq1Range.length, x = t.countLinesIn(g.seq2Range), U = g.seq2Range.length, L = 2 * 40 + 50;
        function T(S) {
          return Math.min(S, L);
        }
        return Math.pow(Math.pow(T(C * 40 + M), 1.5) + Math.pow(T(D * 40 + N), 1.5), 1.5) + Math.pow(Math.pow(T(b * 40 + p), 1.5) + Math.pow(T(x * 40 + U), 1.5), 1.5) > (L ** 1.5) ** 1.5 * 1.3;
      };
      var l = m;
      const c = i[u], d = o[o.length - 1];
      m(d, c) ? (s = !0, o[o.length - 1] = o[o.length - 1].join(c)) : o.push(c);
    }
    i = o;
  } while (r++ < 10 && s);
  const a = [];
  return Mu(i, (o, u, c) => {
    ...
    const f = e.extendToFullLines(u.seq1Range), _ = e.getText(new j(f.start, u.seq1Range.start));
    m(_) && (d = d.deltaStart(-_.length));
    const g = e.getText(new j(u.seq1Range.endExclusive, f.endExclusive));
    m(g) && (d = d.deltaEnd(g.length));
    const k = K.fromOffsetPairs(o ? o.getEndExclusives() : De.zero, c ? c.getStarts() : De.max), y = d.intersect(k);
...
class Qu {
  constructor() {
    this.dynamicProgrammingDiffing = new zu(), this.myersDiffingAlgorithm = new uo();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && Cu(t, n, (D, N) => D === N))
      return new $t([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new $t([
        new Ue(new O(1, t.length + 1), new O(1, n.length + 1), [
          new Le(new G(1, 1, t.length, t[t.length - 1].length + 1), new G(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const r = i.maxComputationTimeMs === 0 ? Ht.instance : new Iu(i.maxComputationTimeMs), s = !i.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function l(D) {
      let N = a.get(D);
      return N === void 0 && (N = a.size, a.set(D, N)), N;
    }
    const o = t.map((D) => l(D.trim())), u = n.map((D) => l(D.trim())), c = new Ts(o, t), d = new Ts(u, n), m = c.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, d, r, (D, N) => t[D] === n[N] ? n[N].length === 0 ? 0.1 : 1 + Math.log(1 + n[N].length) : 0.99) : this.myersDiffingAlgorithm.compute(c, d, r);
    let f = m.diffs, _ = m.hitTimeout;
    f = vs(c, d, f), f = Ju(c, d, f);
    const g = [], k = (D) => {
      if (s)
        for (let N = 0; N < D; N++) {
          const b = y + N, p = v + N;
          if (t[b] !== n[p]) {
            const x = this.refineDiff(t, n, new K(new j(b, b + 1), new j(p, p + 1)), r, s);
            for (const U of x.mappings)
              g.push(U);
            x.hitTimeout && (_ = !0);
          }
        }
    ...
    let y = 0, v = 0;
    for (const D of f) {
      sn(() => D.seq1Range.start - y === D.seq2Range.start - v);
      const N = D.seq1Range.start - y;
      k(N), y = D.seq1Range.endExclusive, v = D.seq2Range.endExclusive;
      const b = this.refineDiff(t, n, D, r, s);
      b.hitTimeout && (_ = !0);
      for (const p of b.mappings)
        g.push(p);
    }
    k(t.length - y);
    const C = As(g, t, n);
    let M = [];
    return i.computeMoves && (M = this.computeMoves(C, t, n, o, u, r, s)), sn(() => {
      function D(b, p) {
        if (b.lineNumber < 1 || b.lineNumber > p.length)
          return !1;
        const x = p[b.lineNumber - 1];
        return !(b.column < 1 || b.column > x.length + 1);
      }
      function N(b, p) {
        return !(b.startLineNumber < 1 || b.startLineNumber > p.length + 1 || b.endLineNumberExclusive < 1 || b.endLineNumberExclusive > p.length + 1);
      }
      for (const b of C) {
        if (!b.innerChanges)
          return !1;
        for (const p of b.innerChanges)
          if (!(D(p.modifiedRange.getStartPosition(), n) && D(p.modifiedRange.getEndPosition(), n) && D(p.originalRange.getStartPosition(), t) && D(p.originalRange.getEndPosition(), t)))
            return !1;
        if (!N(b.modified, n) || !N(b.original, t))
          return !1;
      }
      return !0;
    }), new $t(C, M, _);
  ...
  computeMoves(t, n, i, r, s, a, l) {
    return Fu(t, n, i, r, s, a).map((c) => {
      const d = this.refineDiff(n, i, new K(c.original.toOffsetRange(), c.modified.toOffsetRange()), a, l), m = As(d.mappings, n, i, !0);
      return new vu(c, m);
    });
  }
  refineDiff(t, n, i, r, s) {
    const l = Ku(i).toRangeMapping2(t, n), o = new ln(t, l.originalRange, s), u = new ln(n, l.modifiedRange, s), c = o.length + u.length < 500 ? this.dynamicProgrammingDiffing.compute(o, u, r) : this.myersDiffingAlgorithm.compute(o, u, r);
    let d = c.diffs;
    return d = vs(o, u, d), d = Gu(o, u, d), d = $u(o, u, d), d = Yu(o, u, d), {
      mappings: d.map((f) => new Le(o.translateRange(f.seq1Range), u.translateRange(f.seq2Range))),
      hitTimeout: c.hitTimeout
    };
  }
}
function As(e, t, n, i = !1) {
  const r = [];
  for (const s of Eu(e.map((a) => Zu(a, t, n)), (a, l) => a.original.overlapOrTouch(l.original) || a.modified.overlapOrTouch(l.modified))) {
    const a = s[0], l = s[s.length - 1];
    r.push(new Ue(a.original.join(l.original), a.modified.join(l.modified), s.map((o) => o.innerChanges[0])));
  }
  return sn(() => !i && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length - r[r.length - 1].modified.endLineNumberExclusive !== t.length - r[r.length - 1].original.endLineNumberExclusive) ? !1 : ro(r, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
...
function Zu(e, t, n) {
  ...
  const s = new O(e.originalRange.startLineNumber + i, e.originalRange.endLineNumber + 1 + r), a = new O(e.modifiedRange.startLineNumber + i, e.modifiedRange.endLineNumber + 1 + r);
  return new Ue(s, a, [e]);
}
function Ku(e) {
  return new xe(new O(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new O(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const Ss = {
  getLegacy: () => new ku(),
  getDefault: () => new Qu()
...
class ye {
  ...
  static toRGBA(t) {
    ...
    if (i === 0)
      ...
      a = ye._hue2rgb(c, u, n + 1 / 3), l = ye._hue2rgb(c, u, n), o = ye._hue2rgb(c, u, n - 1 / 3);
    }
    return new ie(Math.round(a * 255), Math.round(l * 255), Math.round(o * 255), s);
  }
}
class lt {
  constructor(t, n, i, r) {
  ...
  static fromRGBA(t) {
    ...
    let u;
    return l === 0 ? u = 0 : s === n ? u = ((i - r) / l % 6 + 6) % 6 : s === i ? u = (r - n) / l + 2 : u = (n - i) / l + 4, new lt(Math.round(u * 60), o, s, t.a);
  }
  // from http://www.rapidtables.com/convert/color/hsv-to-rgb.htm
  static toRGBA(t) {
    const { h: n, s: i, v: r, a: s } = t, a = r * i, l = a * (1 - Math.abs(n / 60 % 2 - 1)), o = r - a;
    let [u, c, d] = [0, 0, 0];
    return n < 60 ? (u = a, c = l) : n < 120 ? (u = l, c = a) : n < 180 ? (c = a, d = l) : n < 240 ? (c = l, d = a) : n < 300 ? (u = l, d = a) : n <= 360 && (u = a, d = l), u = Math.round((u + o) * 255), c = Math.round((c + o) * 255), d = Math.round((d + o) * 255), new ie(u, c, d, s);
  }
}
var X;
let un = (X = class {
  ...
  constructor(t) {
    if (t)
      if (t instanceof ie)
        ...
        this._hsla = t, this.rgba = ye.toRGBA(t);
  ...
  equals(t) {
    return !!t && ie.equals(this.rgba, t.rgba) && ye.equals(this.hsla, t.hsla) && lt.equals(this.hsva, t.hsva);
  }
  /**
  ...
  getRelativeLuminance() {
    const t = X._relativeLuminanceForComponent(this.rgba.r), n = X._relativeLuminanceForComponent(this.rgba.g), i = X._relativeLuminanceForComponent(this.rgba.b), r = 0.2126 * t + 0.7152 * n + 0.0722 * i;
    return Xe(r, 4);
  }
  ...
  lighten(t) {
    return new X(new ye(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new X(new ye(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
  ...
  opposite() {
    return new X(new ie(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  makeOpaque(t) {
    if (this.isOpaque() || t.rgba.a !== 1)
      return this;
    const { r: n, g: i, b: r, a: s } = this.rgba;
    return new X(new ie(t.rgba.r - s * (t.rgba.r - n), t.rgba.g - s * (t.rgba.g - i), t.rgba.b - s * (t.rgba.b - r), 1));
  }
  toString() {
...
}, X.white = new X(new ie(255, 255, 255, 1)), X.black = new X(new ie(0, 0, 0, 1)), X.red = new X(new ie(255, 0, 0, 1)), X.blue = new X(new ie(0, 0, 255, 1)), X.green = new X(new ie(0, 255, 0, 1)), X.cyan = new X(new ie(0, 255, 255, 1)), X.lightgrey = new X(new ie(211, 211, 211, 1)), X.transparent = new X(new ie(0, 0, 0, 0)), X);
(function(e) {
  (function(t) {
    (function(n) {
      function i(f) {
      ...
      n.formatHex = o;
      function u(f, _ = !1) {
        return _ && f.rgba.a === 1 ? e.Format.CSS.formatHex(f) : `#${l(f.rgba.r)}${l(f.rgba.g)}${l(f.rgba.b)}${l(Math.round(f.rgba.a * 255))}`;
      }
      n.formatHexA = u;
      function c(f) {
      ...
      function d(f) {
        ...
        if (_ === 7) {
          ...
          return new e(new ie(g, k, y, 1));
        }
        if (_ === 9) {
          const g = 16 * m(f.charCodeAt(1)) + m(f.charCodeAt(2)), k = 16 * m(f.charCodeAt(3)) + m(f.charCodeAt(4)), y = 16 * m(f.charCodeAt(5)) + m(f.charCodeAt(6)), v = 16 * m(f.charCodeAt(7)) + m(f.charCodeAt(8));
          return new e(new ie(g, k, y, v / 255));
        }
        if (_ === 4) {
          const g = m(f.charCodeAt(1)), k = m(f.charCodeAt(2)), y = m(f.charCodeAt(3));
          return new e(new ie(16 * g + g, 16 * k + k, 16 * y + y));
        }
        if (_ === 5) {
          const g = m(f.charCodeAt(1)), k = m(f.charCodeAt(2)), y = m(f.charCodeAt(3)), v = m(f.charCodeAt(4));
          return new e(new ie(16 * g + g, 16 * k + k, 16 * y + y, (16 * v + v) / 255));
        }
        return null;
      }
      n.parseHex = d;
...
function ec(e, t) {
  if (!e)
    return;
  const n = un.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
...
function Ls(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = co(r);
  return {
    range: e,
    color: Hi(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function Cs(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = co(r), a = new un(new ye(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1));
  return {
    range: e,
    color: Hi(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function Tt(e, t) {
...
function tc(e) {
  const t = [], i = Tt(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (i.length > 0)
    for (const r of i) {
...
function nc(e) {
  return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : tc(e);
}
const Es = new RegExp("\\bMARK:\\s*(.*)$", "d"), ic = /^-+|-+$/g;
function rc(e, t) {
  var i;
  let n = [];
...
const he = class he {
  ...
  static map(t, n) {
    return new he(async (i) => {
      for await (const r of t)
        i.emitOne(n(r));
    });
  }
  map(t) {
    return he.map(this, t);
  }
  static filter(t, n) {
    return new he(async (i) => {
      for await (const r of t)
  ...
  filter(t) {
    return he.filter(this, t);
  }
  static coalesce(t) {
    return he.filter(t, (n) => !!n);
  }
  coalesce() {
    return he.coalesce(this);
  }
...
class hc {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new dc(Re.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class dc extends cc {
  ...
  getWordAtPosition(t, n) {
    const i = Ui(t.column, ao(n), this._lines[t.lineNumber - 1], 0);
    return i ? new G(t.lineNumber, i.startColumn, t.lineNumber, i.endColumn) : null;
  }
  words(t) {
...
const Sn = class Sn {
  constructor() {
    this._workerTextModelSyncServer = new hc();
  }
  dispose() {
  }
  _getModel(t) {
  ...
  async $computeUnicodeHighlights(t, n, i) {
    ...
    return r ? _u.computeUnicodeHighlights(r, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async $computeDiff(t, n, i, r) {
    ...
    return !s || !a ? null : Jt.computeDiff(s, a, i, r);
  }
  static computeDiff(t, n, i, r) {
    const s = r === "advanced" ? Ss.getDefault() : Ss.getLegacy(), a = t.getLinesContent(), l = n.getLinesContent(), o = s.computeDiff(a, l, i), u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function c(d) {
      return d.map((m) => {
        var f;
        return [m.original.startLineNumber, m.original.endLineNumberExclusive, m.modified.startLineNumber, m.modified.endLineNumberExclusive, (f = m.innerChanges) == null ? void 0 : f.map((_) => [
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    for (let { range: o, text: u, eol: c } of n) {
      if (typeof c == "number" && (a = c), G.isEmpty(o) && !u)
        continue;
      const d = r.getValueInRange(o);
      if (u = u.replace(/\r\n|\n|\r/g, r.eol), d === u)
        continue;
      if (Math.max(u.length, d.length) > Jt._diffLimit) {
        s.push({ range: o, text: u });
        continue;
      }
      const m = Fl(d, u, i), f = r.offsetAt(G.lift(o).getStartPosition());
      for (const _ of m) {
        const g = r.positionAt(f + _.originalStart), k = r.positionAt(f + _.originalStart + _.originalLength), y = {
  ...
  async $textualSuggest(t, n, i, r) {
    const s = new Ln(), a = new RegExp(i, r), l = /* @__PURE__ */ new Set();
    e:
      for (const o of t) {
        const u = this._getModel(o);
        if (u) {
          for (const c of u.words(a))
            if (!(c === n || !isNaN(Number(c))) && (l.add(c), l.size > Jt._suggestionsLimit))
              break e;
        }
      }
  ...
  async $navigateValueSet(t, n, i, r, s) {
    ...
    return Yn.INSTANCE.navigateValueSet(n, o, u, c, i);
  }
};
Sn._diffLimit = 1e5, Sn._suggestionsLimit = 1e4;
let ci = Sn;
class Jt extends ci {
  constructor(t, n) {
  ...
  $loadForeignModule(t, n, i) {
    const a = {
      host: uu(i, (l, o) => this._host.$fhr(l, o)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(a, n), Promise.resolve(ss(this._foreignModule))) : new Promise((l, o) => {
      const u = (c) => {
        this._foreignModule = c.create(a, n), l(ss(this._foreignModule));
      };
...
typeof importScripts == "function" && (globalThis.monaco = tu());
let hi = !1;
function mo(e) {
  if (hi)
    return;
...
var mc = /{([^}]+)}/g;
function fc(e, t) {
  return Object.keys(t).length === 0 ? e : e.replace(mc, (n, i) => t[i] ?? n);
}
var Ns;
(function(e) {
  function t(n) {
...
(function(e) {
  function t(i, r) {
    return i === Number.MAX_VALUE && (i = cn.MAX_VALUE), r === Number.MAX_VALUE && (r = cn.MAX_VALUE), { line: i, character: r };
  }
  e.create = t;
  function n(i) {
    let r = i;
...
(function(e) {
  function t(i, r, s, a) {
    if (E.uinteger(i) && E.uinteger(r) && E.uinteger(s) && E.uinteger(a))
      return { start: re.create(i, r), end: re.create(s, a) };
    if (re.is(i) && re.is(r))
  ...
  function n(i) {
    let r = i;
    return E.objectLiteral(r) && re.is(r.start) && re.is(r.end);
  }
  e.is = n;
})($ || ($ = {}));
var hn;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return E.objectLiteral(r) && $.is(r.range) && (E.string(r.uri) || E.undefined(r.uri));
  }
  e.is = n;
})(hn || (hn = {}));
var Is;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return E.objectLiteral(r) && $.is(r.targetRange) && E.string(r.targetUri) && $.is(r.targetSelectionRange) && ($.is(r.originSelectionRange) || E.undefined(r.originSelectionRange));
  }
  e.is = n;
})(Is || (Is = {}));
var mi;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return E.objectLiteral(r) && E.numberRange(r.red, 0, 1) && E.numberRange(r.green, 0, 1) && E.numberRange(r.blue, 0, 1) && E.numberRange(r.alpha, 0, 1);
  }
  e.is = n;
})(mi || (mi = {}));
var zs;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return E.objectLiteral(r) && $.is(r.range) && mi.is(r.color);
  }
  e.is = n;
})(zs || (zs = {}));
var Us;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return E.objectLiteral(r) && E.string(r.label) && (E.undefined(r.textEdit) || oe.is(r)) && (E.undefined(r.additionalTextEdits) || E.typedArray(r.additionalTextEdits, oe.is));
  }
  e.is = n;
})(Us || (Us = {}));
var dn;
...
(function(e) {
  function t(i, r, s, a, l, o) {
    ...
    return E.defined(s) && (u.startCharacter = s), E.defined(a) && (u.endCharacter = a), E.defined(l) && (u.kind = l), E.defined(o) && (u.collapsedText = o), u;
  }
  e.create = t;
  function n(i) {
    const r = i;
    return E.objectLiteral(r) && E.uinteger(r.startLine) && E.uinteger(r.startLine) && (E.undefined(r.startCharacter) || E.uinteger(r.startCharacter)) && (E.undefined(r.endCharacter) || E.uinteger(r.endCharacter)) && (E.undefined(r.kind) || E.string(r.kind));
  }
  e.is = n;
})(Hs || (Hs = {}));
var fi;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return E.defined(r) && hn.is(r.location) && E.string(r.message);
  }
  e.is = n;
})(fi || (fi = {}));
var Ws;
...
(function(e) {
  function t(i, r, s, a, l, o) {
    ...
    return E.defined(s) && (u.severity = s), E.defined(a) && (u.code = a), E.defined(l) && (u.source = l), E.defined(o) && (u.relatedInformation = o), u;
  }
  e.create = t;
  function n(i) {
    var r;
    let s = i;
    return E.defined(s) && $.is(s.range) && E.string(s.message) && (E.number(s.severity) || E.undefined(s.severity)) && (E.integer(s.code) || E.string(s.code) || E.undefined(s.code)) && (E.undefined(s.codeDescription) || E.string((r = s.codeDescription) === null || r === void 0 ? void 0 : r.href)) && (E.string(s.source) || E.undefined(s.source)) && (E.undefined(s.relatedInformation) || E.typedArray(s.relatedInformation, fi.is));
  }
  e.is = n;
})(mn || (mn = {}));
var _t;
...
(function(e) {
  ...
  function r(s) {
    const a = s;
    return E.objectLiteral(a) && E.string(a.newText) && $.is(a.range);
  }
  e.is = r;
})(oe || (oe = {}));
var pi;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return E.objectLiteral(r) && E.string(r.label) && (E.boolean(r.needsConfirmation) || r.needsConfirmation === void 0) && (E.string(r.description) || r.description === void 0);
  }
  e.is = n;
})(pi || (pi = {}));
var wt;
...
(function(e) {
  ...
  function r(s) {
    const a = s;
    return oe.is(a) && (pi.is(a.annotationId) || wt.is(a.annotationId));
  }
  e.is = r;
})(Bs || (Bs = {}));
var gi;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return E.defined(r) && yi.is(r.textDocument) && Array.isArray(r.edits);
  }
  e.is = n;
})(gi || (gi = {}));
var bi;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "create" && E.string(r.uri) && (r.options === void 0 || (r.options.overwrite === void 0 || E.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || E.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || wt.is(r.annotationId));
  }
  e.is = n;
})(bi || (bi = {}));
var _i;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "rename" && E.string(r.oldUri) && E.string(r.newUri) && (r.options === void 0 || (r.options.overwrite === void 0 || E.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || E.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || wt.is(r.annotationId));
  }
  e.is = n;
})(_i || (_i = {}));
var wi;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "delete" && E.string(r.uri) && (r.options === void 0 || (r.options.recursive === void 0 || E.boolean(r.options.recursive)) && (r.options.ignoreIfNotExists === void 0 || E.boolean(r.options.ignoreIfNotExists))) && (r.annotationId === void 0 || wt.is(r.annotationId));
  }
  e.is = n;
})(wi || (wi = {}));
var vi;
(function(e) {
  function t(n) {
    let i = n;
    return i && (i.changes !== void 0 || i.documentChanges !== void 0) && (i.documentChanges === void 0 || i.documentChanges.every((r) => E.string(r.kind) ? bi.is(r) || _i.is(r) || wi.is(r) : gi.is(r)));
  }
  e.is = t;
})(vi || (vi = {}));
var qs;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r && E.string(r.newText) && $.is(r.insert) && $.is(r.replace);
  }
  e.is = n;
})($s || ($s = {}));
var Gs;
...
(function(e) {
  function t(n) {
    let i = n;
    return !!i && E.objectLiteral(i) && (Wt.is(i.contents) || fn.is(i.contents) || E.typedArray(i.contents, fn.is)) && (n.range === void 0 || $.is(n.range));
  }
  e.is = t;
})(Qs || (Qs = {}));
var Zs;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && E.string(r.name) && E.number(r.kind) && $.is(r.range) && $.is(r.selectionRange) && (r.detail === void 0 || E.string(r.detail)) && (r.deprecated === void 0 || E.boolean(r.deprecated)) && (r.children === void 0 || Array.isArray(r.children)) && (r.tags === void 0 || Array.isArray(r.tags));
  }
  e.is = n;
})(ki || (ki = {}));
var ia;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return E.defined(r) && E.typedArray(r.diagnostics, mn.is) && (r.only === void 0 || E.typedArray(r.only, E.string)) && (r.triggerKind === void 0 || r.triggerKind === gn.Invoked || r.triggerKind === gn.Automatic);
  }
  e.is = n;
})(ra || (ra = {}));
var sa;
(function(e) {
  function t(i, r, s) {
    let a = { title: i }, l = !0;
    return typeof r == "string" ? (l = !1, a.kind = r) : _t.is(r) ? a.command = r : a.edit = r, l && s !== void 0 && (a.kind = s), a;
  }
  e.create = t;
  function n(i) {
    let r = i;
    return r && E.string(r.title) && (r.diagnostics === void 0 || E.typedArray(r.diagnostics, mn.is)) && (r.kind === void 0 || E.string(r.kind)) && (r.edit !== void 0 || r.command !== void 0) && (r.command === void 0 || _t.is(r.command)) && (r.isPreferred === void 0 || E.boolean(r.isPreferred)) && (r.edit === void 0 || vi.is(r.edit));
  }
  e.is = n;
})(sa || (sa = {}));
var aa;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return E.defined(r) && $.is(r.range) && (E.undefined(r.command) || _t.is(r.command));
  }
  e.is = n;
})(aa || (aa = {}));
var oa;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return E.defined(r) && $.is(r.range) && (E.undefined(r.target) || E.string(r.target));
  }
  e.is = n;
})(la || (la = {}));
var bn;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return E.objectLiteral(r) && $.is(r.range) && (r.parent === void 0 || e.is(r.parent));
  }
  e.is = n;
})(bn || (bn = {}));
var ua;
...
(function(e) {
  function t(n) {
    const i = n;
    return E.objectLiteral(i) && (i.resultId === void 0 || typeof i.resultId == "string") && Array.isArray(i.data) && (i.data.length === 0 || typeof i.data[0] == "number");
  }
  e.is = t;
})(ha || (ha = {}));
var da;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && $.is(r.range) && E.string(r.text);
  }
  e.is = n;
})(da || (da = {}));
var ma;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && $.is(r.range) && E.boolean(r.caseSensitiveLookup) && (E.string(r.variableName) || r.variableName === void 0);
  }
  e.is = n;
})(ma || (ma = {}));
var fa;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && $.is(r.range) && (E.string(r.expression) || r.expression === void 0);
  }
  e.is = n;
})(fa || (fa = {}));
var pa;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return E.defined(r) && $.is(i.stoppedLocation);
  }
  e.is = n;
})(pa || (pa = {}));
var Ai;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return E.objectLiteral(r) && (r.tooltip === void 0 || E.string(r.tooltip) || Wt.is(r.tooltip)) && (r.location === void 0 || hn.is(r.location)) && (r.command === void 0 || _t.is(r.command));
  }
  e.is = n;
})(Si || (Si = {}));
var ga;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return E.objectLiteral(r) && re.is(r.position) && (E.string(r.label) || E.typedArray(r.label, Si.is)) && (r.kind === void 0 || Ai.is(r.kind)) && r.textEdits === void 0 || E.typedArray(r.textEdits, oe.is) && (r.tooltip === void 0 || E.string(r.tooltip) || Wt.is(r.tooltip)) && (r.paddingLeft === void 0 || E.boolean(r.paddingLeft)) && (r.paddingRight === void 0 || E.boolean(r.paddingRight));
  }
  e.is = n;
})(ga || (ga = {}));
var ba;
...
(function(e) {
  function t(n) {
    const i = n;
    return E.objectLiteral(i) && di.is(i.uri) && E.string(i.name);
  }
  e.is = t;
})(Ta || (Ta = {}));
var ka;
(function(e) {
  ...
  function i(s, a) {
    ...
    for (let c = o.length - 1; c >= 0; c--) {
      let d = o[c], m = s.offsetAt(d.range.start), f = s.offsetAt(d.range.end);
      if (f <= u)
...
(function(e) {
  ...
  e.number = a;
  function l(f, _, g) {
    return t.call(f) === "[object Number]" && _ <= f && f <= g;
  }
  e.numberRange = l;
  function o(f) {
  ...
  e.objectLiteral = d;
  function m(f, _) {
    return Array.isArray(f) && f.every(_);
  }
  e.typedArray = m;
})(E || (E = {}));
var Aa = class Li {
  ...
  update(t, n) {
    for (let i of t)
      if (Li.isIncremental(i)) {
        const r = fo(i.range), s = this.offsetAt(r.start), a = this.offsetAt(r.end);
        ...
        if (d !== 0)
          for (let m = l + 1 + c.length, f = u.length; m < f; m++)
            u[m] = u[m] + d;
      } else if (Li.isFull(i))
  ...
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = Sa(this._content, !0)), this._lineOffsets;
  }
  positionAt(t) {
...
(function(e) {
  ...
  e.update = n;
  function i(r, s) {
    let a = r.getText(), l = Ei(s.map(gc), (c, d) => {
      let m = c.range.start.line - d.range.start.line;
      return m === 0 ? c.range.start.character - d.range.start.character : m;
    }), o = 0;
    const u = [];
...
(function(e) {
  e.LATEST = {
    textDocument: {
      completion: {
        completionItem: {
          documentationFormat: [Ie.Markdown, Ie.PlainText]
        }
      },
      hover: {
        contentFormat: [Ie.Markdown, Ie.PlainText]
      }
    }
  };
})(La || (La = {}));
...
var bc = class {
  ...
  skipWhitespace() {
    return this.advanceWhileChar((t) => t === kc || t === Ac || t === yc || t === Tc || t === xc) > 0;
  }
  advanceWhileChar(e) {
...
}, Ca = 33, at = 45, qt = 60, Ce = 62, Wn = 47, _c = 61, wc = 34, vc = 39, yc = 10, xc = 13, Tc = 12, kc = 32, Ac = 9, Sc = {
  "text/x-handlebars-template": !0,
  // Fix for https://github.com/microsoft/vscode/issues/77977
  "text/html": !0
};
function _e(e, t = 0, n = B.WithinContent, i = !1) {
  const r = new bc(e, t);
  ...
  function g(v, C, M) {
    return l = C, a = v, o = M, C;
  }
  function k() {
    const v = r.pos(), C = s, M = y();
    return M !== z.EOS && v === r.pos() && !(i && (M === z.StartTagClose || M === z.EndTagClose)) ? (console.warn("Scanner.scan has not advanced at offset " + v + ", state before: " + C + " after: " + s), r.advance(1), g(v, z.Unknown)) : M;
  }
  function y() {
    const v = r.pos();
    if (r.eos())
    ...
    switch (s) {
      case B.WithinComment:
        return r.advanceIfChars([at, at, Ce]) ? (s = B.WithinContent, g(v, z.EndCommentTag)) : (r.advanceUntilChars([at, at, Ce]), g(v, z.Comment));
      case B.WithinDoctype:
        return r.advanceIfChar(Ce) ? (s = B.WithinContent, g(v, z.EndDoctypeTag)) : (r.advanceUntilChar(Ce), g(v, z.Doctype));
      case B.WithinContent:
        if (r.advanceIfChar(qt)) {
          if (!r.eos() && r.peekChar() === Ca) {
            if (r.advanceIfChars([Ca, at, at]))
              return s = B.WithinComment, g(v, z.StartCommentTag);
            if (r.advanceIfRegExp(/^!doctype/i))
              return s = B.WithinDoctype, g(v, z.StartDoctypeTag);
          }
          return r.advanceIfChar(Wn) ? (s = B.AfterOpeningEndTag, g(v, z.EndTagOpen)) : (s = B.AfterOpeningStartTag, g(v, z.StartTagOpen));
        }
        return r.advanceUntilChar(qt), g(v, z.Content);
      case B.AfterOpeningEndTag:
        return f().length > 0 ? (s = B.WithinEndTag, g(v, z.EndTag)) : r.skipWhitespace() ? g(v, z.Whitespace, Ae("Tag name must directly follow the open bracket.")) : (s = B.WithinEndTag, r.advanceUntilChar(Ce), v < r.pos() ? g(v, z.Unknown, Ae("End tag name expected.")) : y());
      case B.WithinEndTag:
        if (r.skipWhitespace())
          return g(v, z.Whitespace);
        if (r.advanceIfChar(Ce))
          return s = B.WithinContent, g(v, z.EndTagClose);
        if (i && r.peekChar() === qt)
          return s = B.WithinContent, g(v, z.EndTagClose, Ae("Closing bracket missing."));
        C = Ae("Closing bracket expected.");
        break;
      case B.AfterOpeningStartTag:
        return c = f(), m = void 0, d = void 0, c.length > 0 ? (u = !1, s = B.WithinTag, g(v, z.StartTag)) : r.skipWhitespace() ? g(v, z.Whitespace, Ae("Tag name must directly follow the open bracket.")) : (s = B.WithinTag, r.advanceUntilChar(Ce), v < r.pos() ? g(v, z.Unknown, Ae("Start tag name expected.")) : y());
      case B.WithinTag:
        return r.skipWhitespace() ? (u = !0, g(v, z.Whitespace)) : u && (d = _(), d.length > 0) ? (s = B.AfterAttributeName, u = !1, g(v, z.AttributeName)) : r.advanceIfChars([Wn, Ce]) ? (s = B.WithinContent, g(v, z.StartTagSelfClose)) : r.advanceIfChar(Ce) ? (c === "script" ? m && Sc[m] ? s = B.WithinContent : s = B.WithinScriptContent : c === "style" ? s = B.WithinStyleContent : s = B.WithinContent, g(v, z.StartTagClose)) : i && r.peekChar() === qt ? (s = B.WithinContent, g(v, z.StartTagClose, Ae("Closing bracket missing."))) : (r.advance(1), g(v, z.Unknown, Ae("Unexpected character in tag.")));
      case B.AfterAttributeName:
        return r.skipWhitespace() ? (u = !0, g(v, z.Whitespace)) : r.advanceIfChar(_c) ? (s = B.BeforeAttributeValue, g(v, z.DelimiterAssign)) : (s = B.WithinTag, y());
      case B.BeforeAttributeValue:
        if (r.skipWhitespace())
          return g(v, z.Whitespace);
        let D = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
        if (D.length > 0 && (r.peekChar() === Ce && r.peekChar(-1) === Wn && (r.goBack(1), D = D.substring(0, D.length - 1)), d === "type" && (m = D), D.length > 0))
          return s = B.WithinTag, u = !1, g(v, z.AttributeValue);
        const N = r.peekChar();
        return N === vc || N === wc ? (r.advance(1), r.advanceUntilChar(N) && r.advance(1), d === "type" && (m = r.getSource().substring(v + 1, r.pos() - 1)), s = B.WithinTag, u = !1, g(v, z.AttributeValue)) : (s = B.WithinTag, u = !1, y());
      case B.WithinScriptContent:
        let b = 1;
        for (; !r.eos(); ) {
          const p = r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
          if (p.length === 0)
            return r.goToEnd(), g(v, z.Script);
          if (p === "<!--")
            b === 1 && (b = 2);
          else if (p === "-->")
            b = 1;
        ...
        return s = B.WithinContent, v < r.pos() ? g(v, z.Script) : y();
      case B.WithinStyleContent:
        return r.advanceUntilRegExp(/<\/style/i), s = B.WithinContent, v < r.pos() ? g(v, z.Styles) : y();
    }
    return r.advance(1), s = B.WithinContent, g(v, z.Unknown, C);
  }
  return {
    scan: k,
    getTokenType: () => l,
...
var Ra = class {
  ...
  findNodeBefore(e) {
    const t = Ea(this.children, (n) => e <= n.start) - 1;
    if (t >= 0) {
  ...
  parse(e, t) {
    const n = _e(e, void 0, void 0, !0), i = new Ra(0, e.length, [], void 0);
    let r = i, s = -1, a, l = null, o = n.scan();
    for (; o !== z.EOS; ) {
      switch (o) {
        case z.StartTagOpen:
          const u = new Ra(n.getTokenOffset(), e.length, [], r);
...
var Rc = 97, Mc = 122, Nc = 65, Dc = 90, Ic = 48, zc = 57;
function kt(e, t) {
  const n = e.charCodeAt(t);
  return Rc <= n && n <= Mc || Nc <= n && n <= Dc || Ic <= n && n <= zc;
}
function _n(e) {
  return typeof e < "u";
}
...
var Hc = class {
  ...
  async computeCompletions(e, t) {
    ...
    for (const i of this.atributeCompletions) {
      const r = Fc(e.getText(i.range));
      if (Pc(r))
        if (r === "." || r === "..")
          n.isIncomplete = !0;
        else {
          const s = Bc(i.value, r, i.range), a = await this.providePathSuggestions(i.value, s, e, t);
          for (const l of a)
            n.items.push(l);
        }
    }
  ...
  async providePathSuggestions(e, t, n, i) {
    ...
    if (s)
      try {
        ...
        for (const [o, u] of l)
          o.charCodeAt(0) !== Wc && a.push(qc(o, u === Ri.Directory, t));
        return a;
      } catch {
      }
    return [];
...
function Bc(e, t, n) {
  ...
  if (r === -1)
    ...
    const s = t.slice(r + 1), a = Et(n.end, -1 - s.length), l = s.indexOf(" ");
    let o;
    l !== -1 ? o = Et(a, l) : o = Et(n.end, -1), i = $.create(a, o);
  }
  return i;
}
function qc(e, t, n) {
...
function Oc(e, t, n) {
  const i = Et(e.start, t), r = Et(e.end, n);
  return $.create(i, r);
}
var Vc = class {
  constructor(e, t) {
  ...
  async doComplete2(e, t, n, i, r) {
    ...
    const s = new Hc(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), a = this.completionParticipants;
  ...
  _doComplete(e, t, n, i) {
    const r = {
      isIncomplete: !1,
      items: []
    }, s = this.completionParticipants, a = this.dataManager.getDataProviders().filter((w) => w.isApplicable(e.languageId) && (!i || i[w.getId()] !== !1)), l = this.dataManager.getVoidElements(a), o = this.doesSupportMarkdown(), u = e.getText(), c = e.offsetAt(t), d = n.findNodeBefore(c);
    if (!d)
      return r;
    const m = _e(u, d.start);
    let f = "", _;
    function g(w, A = c) {
      return w > c && (w = c), { start: e.positionAt(w), end: e.positionAt(A) };
    }
    function k(w, A) {
      const R = g(w, A);
      return a.forEach((I) => {
        I.provideTags().forEach((F) => {
          r.items.push({
            label: F.name,
            kind: fe.Property,
            documentation: et(F, void 0, o),
            textEdit: oe.replace(R, F.name),
    ...
    function y(w) {
      let A = w;
      for (; A > 0; ) {
        const R = u.charAt(A - 1);
        if (`
\r`.indexOf(R) >= 0)
          return u.substring(A, w);
        if (!wn(R))
          return null;
        A--;
      }
      return u.substring(0, w);
    }
    function v(w, A, R = c) {
      const I = g(w, R), F = Na(u, R, B.WithinEndTag, z.EndTagClose) ? "" : ">";
      let H = d;
      for (A && (H = H.parent); H; ) {
        const W = H.tag;
        if (W && (!H.closed || H.endTagStart && H.endTagStart > c)) {
          const q = {
            label: "/" + W,
            kind: fe.Property,
            filterText: "/" + W,
            textEdit: oe.replace(I, "/" + W + F),
            insertTextFormat: ke.PlainText
          }, J = y(H.start), se = y(w - 1);
          if (J !== null && se !== null && J !== se) {
            const de = J + "</" + W + F;
            q.textEdit = oe.replace(g(w - 1 - se.length), de), q.filterText = se + "</" + W;
          }
          return r.items.push(q), r;
        }
        H = H.parent;
      }
      return A || a.forEach((W) => {
        W.provideTags().forEach((q) => {
          r.items.push({
            label: "/" + q.name,
            kind: fe.Property,
            documentation: et(q, void 0, o),
            filterText: "/" + q.name + F,
            textEdit: oe.replace(I, "/" + q.name + F),
            insertTextFormat: ke.PlainText
          });
        });
      }), r;
    ...
    const C = (w, A) => {
      if (i && i.hideAutoCompleteProposals)
        return r;
      if (!this.dataManager.isVoidElement(A, l)) {
        const R = e.positionAt(w);
        r.items.push({
          label: "</" + A + ">",
          kind: fe.Property,
          filterText: "</" + A + ">",
          textEdit: oe.insert(R, "$0</" + A + ">"),
    ...
    function N(w, A = c) {
      ...
      for (; R < A && u[R] !== "<"; )
        R++;
      const I = u.substring(w, A), F = g(w, R);
      let H = "";
      if (!Na(u, A, B.AfterAttributeName, z.DelimiterAssign)) {
        const q = (i == null ? void 0 : i.attributeDefaultValue) ?? "doublequotes";
        q === "empty" ? H = "=$1" : q === "singlequotes" ? H = "='$1'" : H = '="$1"';
      }
      const W = D();
      return W[I] = !1, a.forEach((q) => {
        q.provideAttributes(f).forEach((J) => {
          if (W[J.name])
            return;
          W[J.name] = !0;
          let se = J.name, de;
          J.valueSet !== "v" && H.length && (se = se + H, (J.valueSet || J.name === "style") && (de = {
            title: "Suggest",
            command: "editor.action.triggerSuggest"
          })), r.items.push({
            label: J.name,
            kind: J.valueSet === "handler" ? fe.Function : fe.Value,
            documentation: et(J, void 0, o),
    ...
    function b(w, A) {
      ...
      I[R] = `${R}$1="$2"`;
      function F(H) {
        H.attributeNames.forEach((W) => {
          Je(W, R) && !I[W] && !A[W] && (I[W] = W + '="$1"');
        }), H.children.forEach((W) => F(W));
      }
      n && n.roots.forEach((H) => F(H)), Object.keys(I).forEach((H) => r.items.push({
        label: H,
        kind: fe.Value,
        textEdit: oe.replace(w, I[H]),
        insertTextFormat: ke.Snippet
      }));
    }
    function p(w, A = c) {
      ...
      if (c > w && c <= A && jc(u[w])) {
        ...
        let W = A;
        A > w && u[A - 1] === u[w] && W--;
        const q = $c(u, c, H), J = Gc(u, c, W);
        R = g(q, J), F = c >= H && c <= W ? u.substring(H, c) : "", I = !1;
      } else
        R = g(w, A), F = u.substring(w, c), I = !0;
      if (s.length > 0) {
        const H = f.toLowerCase(), W = _.toLowerCase(), q = g(w, A);
        for (const J of s)
          J.onHtmlAttributeValue && J.onHtmlAttributeValue({ document: e, position: t, tag: H, attribute: W, value: F, range: q });
      }
      return a.forEach((H) => {
        H.provideValues(f, _).forEach((W) => {
          const q = I ? '"' + W.name + '"' : W.name;
          r.items.push({
            label: W.name,
            filterText: q,
            kind: fe.Unit,
            documentation: et(W, void 0, o),
            textEdit: oe.replace(R, q),
            insertTextFormat: ke.PlainText
          });
        });
      }), L(), r;
    ...
    function x(w) {
      return c === m.getTokenEnd() && (S = m.scan(), S === w && m.getTokenOffset() === c) ? m.getTokenEnd() : c;
    }
    function U() {
      for (const w of s)
        w.onHtmlContent && w.onHtmlContent({ document: e, position: t });
      return L();
    }
    function L() {
      let w = c - 1, A = t.character;
      for (; w >= 0 && kt(u, w); )
        w--, A--;
      if (w >= 0 && u[w] === "&") {
        const R = $.create(re.create(t.line, A - 1), t);
        for (const I in Ct)
          if (Ec(I, ";")) {
            const F = "&" + I;
            r.items.push({
              label: F,
              kind: fe.Keyword,
              documentation: Ae("Character entity representing '{0}'", Ct[I]),
              textEdit: oe.replace(R, F),
              insertTextFormat: ke.PlainText
            });
          }
      }
    ...
    function T(w, A) {
      ...
      r.items.push({
        ...
        textEdit: oe.replace(R, "!DOCTYPE html>"),
        insertTextFormat: ke.PlainText
      });
    }
    let S = m.scan();
    for (; S !== z.EOS && m.getTokenOffset() <= c; ) {
      switch (S) {
        case z.StartTagOpen:
          if (m.getTokenEnd() === c) {
            const w = x(z.StartTag);
            return t.line === 0 && T(c, w), M(c, w);
          }
          break;
        case z.StartTag:
        ...
        case z.Whitespace:
          if (c <= m.getTokenEnd())
            switch (m.getScannerState()) {
              case B.AfterOpeningStartTag:
                const w = m.getTokenOffset(), A = x(z.StartTag);
                return M(w, A);
              case B.WithinTag:
              case B.AfterAttributeName:
        ...
        case z.EndTagOpen:
          if (c <= m.getTokenEnd()) {
            const w = m.getTokenOffset() + 1, A = x(z.EndTag);
            return v(w, !1, A);
          }
          break;
        case z.EndTag:
          if (c <= m.getTokenEnd()) {
            let w = m.getTokenOffset() - 1;
            for (; w >= 0; ) {
              const A = u.charAt(w);
              if (A === "/")
                return v(w, !1, m.getTokenEnd());
              if (!wn(A))
                break;
              w--;
            }
  ...
  doesSupportMarkdown() {
    var e, t, n;
    if (!_n(this.supportsMarkdown)) {
      if (!_n(this.lsOptions.clientCapabilities))
      ...
      this.supportsMarkdown = Array.isArray(i) && i.indexOf(Ie.Markdown) !== -1;
    }
...
var Xc = class {
  ...
  doHover(e, t, n, i) {
    ...
    if (!l || !l.tag)
      return null;
    const u = this.dataManager.getDataProviders().filter((N) => N.isApplicable(e.languageId));
    function c(N, b, p) {
      for (const x of u) {
        let U = null;
        if (x.provideTags().forEach((L) => {
          if (L.name.toLowerCase() === N.toLowerCase()) {
            let T = et(L, i, s);
            T || (T = {
              kind: s ? "markdown" : "plaintext",
              value: ""
            }), U = { contents: T, range: b };
          }
        }), U)
    ...
    function d(N, b, p) {
      for (const x of u) {
        let U = null;
        if (x.provideAttributes(N).forEach((L) => {
          if (b === L.name && L.description) {
            const T = et(L, i, s);
            T ? U = { contents: T, range: p } : U = null;
          }
        }), U)
          return U.contents = r(U.contents), U;
      }
    ...
    function m(N, b, p, x) {
      for (const U of u) {
        let L = null;
        if (U.provideValues(N, b).forEach((T) => {
          if (p === T.name && T.description) {
            const S = et(T, i, s);
            S ? L = { contents: S, range: x } : L = null;
          }
        }), L)
    ...
    function f(N, b) {
      ...
      for (const x in Ct) {
        ...
        const L = "&" + x;
        if (p === L) {
          let T = Ct[x].charCodeAt(0).toString(16).toUpperCase(), S = "U+";
          if (T.length < 4) {
            const A = 4 - T.length;
            let R = 0;
            for (; R < A; )
          ...
          S += T;
          const w = Ae("Character entity representing '{0}', unicode equivalent '{1}'", Ct[x], S);
          w ? U = { contents: w, range: b } : U = null;
        }
        if (U)
          return U.contents = r(U.contents), U;
      }
    ...
    function _(N, b) {
      const p = _e(e.getText(), b);
      let x = p.scan();
      for (; x !== z.EOS && (p.getTokenEnd() < a || p.getTokenEnd() === a && x !== N); )
        x = p.scan();
      return x === N && a <= p.getTokenEnd() ? { start: e.positionAt(p.getTokenOffset()), end: e.positionAt(p.getTokenEnd()) } : null;
    }
    function g() {
      let N = a - 1, b = t.character;
      for (; N >= 0 && kt(o, N); )
        N--, b--;
      let p = N + 1, x = b;
      for (; kt(o, p); )
      ...
      if (N >= 0 && o[N] === "&") {
        let U = null;
        return o[p] === ";" ? U = $.create(re.create(t.line, b), re.create(t.line, x + 1)) : U = $.create(re.create(t.line, b), re.create(t.line, x)), U;
      }
      return null;
    }
    function k(N) {
    ...
    if (l.endTagStart && a >= l.endTagStart) {
      ...
      return N ? c(l.tag, N) : null;
    }
    const y = _(z.StartTag, l.start);
    if (y)
      return c(l.tag, y);
    const v = _(z.AttributeName, l.start);
    if (v) {
      const N = l.tag, b = e.getText(v);
      return d(N, b, v);
    }
    const C = g();
    if (C)
      return f(o, C);
    function M(N, b) {
      const p = _e(e.getText(), N);
      let x = p.scan(), U;
      for (; x !== z.EOS && p.getTokenEnd() <= b; )
        x = p.scan(), x === z.AttributeName && (U = p.getTokenText());
      return U;
    }
    const D = _(z.AttributeValue, l.start);
    if (D) {
      const N = l.tag, b = Jc(e.getText(D)), p = M(l.start, e.offsetAt(D.start));
      if (p)
        return m(N, p, b, D);
    }
    return null;
...
You passed in: '` + this.raw_options[o] + "'"
    ...
    function(r, s, a) {
      ...
      function v(C, M) {
        this._source_text = C || "", this._options = new l(M), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
          page: !0,
          "font-face": !0,
          keyframes: !0,
      ...
      v.prototype.eatString = function(C) {
        var M = "";
...
`)
        ...
        return M;
      }, v.prototype.eatWhitespace = function(C) {
        for (var M = _.test(this._input.peek()), D = 0; _.test(this._input.peek()); )
...
` && (D === 0 || D < this._options.max_preserve_newlines) && (D++, this._output.add_new_line(!0));
        ...
        for (var C = 0, M = 1, D = this._input.peek(M); D; ) {
          if (D === "{")
            return !0;
          if (D === "(")
            C += 1;
        ...
        var C = this._source_text, M = this._options.eol;
        M === "auto" && (M = `
`, C && m.test(C || "") && (M = C.match(m)[0])), C = C.replace(f, `
`);
        var D = C.match(/^[\t ]*/)[0];
        this._output = new o(this._options, D), this._input = new u(C), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
        for (var N = 0, b = !1, p = !1, x = !1, U = !1, L = !1, T = this._ch, S = !1, w, A, R; w = this._input.read(g), A = w !== "", R = T, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), T = this._ch, this._ch; )
          if (this._ch === "/" && this._input.peek() === "*") {
            this._output.add_new_line(), this._input.back();
            var I = this._input.read(k), F = d.get_directives(I);
            F && F.ignore === "start" && (I += d.readIgnored(this._input)), this.print_string(I), this.eatWhitespace(!0), this._output.add_new_line();
          } else if (this._ch === "/" && this._input.peek() === "/")
            this._output.space_before_token = !0, this._input.back(), this.print_string(this._input.read(y)), this.eatWhitespace(!0);
          else if (this._ch === "$") {
            this.preserveSingleSpace(A), this.print_string(this._ch);
            var H = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
            H.match(/[ :]$/) && (H = this.eatString(": ").replace(/\s+$/, ""), this.print_string(H), this._output.space_before_token = !0), N === 0 && H.indexOf(":") !== -1 && (p = !0, this.indent());
          } else if (this._ch === "@")
            if (this.preserveSingleSpace(A), this._input.peek() === "{")
              this.print_string(this._ch + this.eatString("}"));
            else {
              this.print_string(this._ch);
              var W = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
              W.match(/[ :]$/) && (W = this.eatString(": ").replace(/\s+$/, ""), this.print_string(W), this._output.space_before_token = !0), N === 0 && W.indexOf(":") !== -1 ? (p = !0, this.indent()) : W in this.NESTED_AT_RULE ? (this._nestedLevel += 1, W in this.CONDITIONAL_GROUP_RULE && (x = !0)) : N === 0 && !p && (U = !0);
            }
          else if (this._ch === "#" && this._input.peek() === "{")
            this.preserveSingleSpace(A), this.print_string(this._ch + this.eatString("}"));
          else if (this._ch === "{")
            p && (p = !1, this.outdent()), U = !1, x ? (x = !1, b = this._indentLevel >= this._nestedLevel) : b = this._indentLevel >= this._nestedLevel - 1, this._options.newline_between_rules && b && this._output.previous_line && this._output.previous_line.item(-1) !== "{" && this._output.ensure_empty_line_above("/", ","), this._output.space_before_token = !0, this._options.brace_style === "expand" ? (this._output.add_new_line(), this.print_string(this._ch), this.indent(), this._output.set_indent(this._indentLevel)) : (R === "(" ? this._output.space_before_token = !1 : R !== "," && this.indent(), this.print_string(this._ch)), this.eatWhitespace(!0), this._output.add_new_line();
          else if (this._ch === "}")
            this.outdent(), this._output.add_new_line(), R === "{" && this._output.trim(!0), p && (this.outdent(), p = !1), this.print_string(this._ch), b = !1, this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && this._input.peek() !== "}" && this._output.add_new_line(!0), this._input.peek() === ")" && (this._output.trim(!0), this._options.brace_style === "expand" && this._output.add_new_line(!0));
          else if (this._ch === ":") {
            ...
            var J = R === '"' || R === "'";
            this.preserveSingleSpace(J || A), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
          } else if (this._ch === ";")
            S = !1, N === 0 ? (p && (this.outdent(), p = !1), U = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
          else if (this._ch === "(")
            if (this._input.lookBack("url"))
              ...
              var se = !1;
              this._input.lookBack("with") && (se = !0), this.preserveSingleSpace(A || se), this.print_string(this._ch), p && R === "$" && this._options.selector_separator_newline ? (this._output.add_new_line(), L = !0) : (this.eatWhitespace(), N++, this.indent());
            }
          else if (this._ch === ")")
            N && (N--, this.outdent()), L && this._input.peek() === ";" && this._options.selector_separator_newline && (L = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch);
          else if (this._ch === ",")
            this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!p || L) && N === 0 && !U ? this._output.add_new_line() : this._output.space_before_token = !0;
          else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !p && N === 0)
            ...
            var de = R === '"' || R === "'";
            this.preserveSingleSpace(de || A), this.print_string(this._ch), !this._output.just_added_newline() && this._input.peek() === `
` && S && this._output.add_new_line();
          }
        var Cn = this._output.get_code(M);
        return Cn;
...
You passed in: '` + this.raw_options[o] + "'"
    ...
    function(r, s, a) {
      var l = a(8).InputScanner, o = a(3).Token, u = a(10).TokenStream, c = a(11).WhitespacePattern, d = {
        ...
        this._input = new l(f), this._options = _ || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new c(this._input);
      };
      m.prototype.tokenize = function() {
        this._input.restart(), this.__tokens = new u(), this._reset();
        for (var f, _ = new o(d.START, ""), g = null, k = [], y = new u(); _.type !== d.EOF; ) {
          for (f = this._get_next_token(_, g); this._is_comment(f); )
            y.add(f), f = this._get_next_token(_, g);
          y.isEmpty() || (f.comments_before = y, y = new u()), f.parent = g, this._is_opening(f) ? (k.push(g), g = f) : g && this._is_closing(f, g) && (f.opened = g, g.closed = f, g = k.pop(), f.parent = g), f.previous = _, _.next = f, this.__tokens.add(f), _ = f;
        }
        return this.__tokens;
      }, m.prototype._is_first_token = function() {
        return this.__tokens.isEmpty();
      }, m.prototype._reset = function() {
      }, m.prototype._get_next_token = function(f, _) {
        ...
        return !1;
      }, m.prototype._is_closing = function(f, _) {
        return !1;
      }, m.prototype._create_token = function(f, _) {
        var g = new o(
          f,
          _,
    ...
    function(r, s, a) {
      var l = a(20).Options, o = a(2).Output, u = a(21).Tokenizer, c = a(21).TOKEN, d = /\r\n|[\r\n]/, m = /\r\n|[\r\n]/g, f = function(b, p) {
        this.indent_level = 0, this.alignment_size = 0, this.max_preserve_newlines = b.max_preserve_newlines, this.preserve_newlines = b.preserve_newlines, this._output = new o(b, p);
      };
      f.prototype.current_line_has_match = function(b) {
        ...
        this._output.space_before_token = b, this._output.non_breaking_space = p;
        ...
        var p = 0;
        b.type !== c.TEXT && b.previous.type !== c.TEXT && (p = b.newlines ? 1 : 0), this.preserve_newlines && (p = b.newlines < this.max_preserve_newlines + 1 ? b.newlines : this.max_preserve_newlines + 1);
        for (var x = 0; x < p; x++)
      ...
      var _ = function(b) {
        for (var p = null, x = b.next; x.type !== c.EOF && b.closed !== x; ) {
          if (x.type === c.ATTRIBUTE && x.text === "type") {
            x.next && x.next.type === c.EQUALS && x.next.next && x.next.next.type === c.VALUE && (p = x.next.next.text);
            break;
          }
          x = x.next;
        }
        ...
        var x = null, U = null;
        return p.closed ? (b === "script" ? x = "text/javascript" : b === "style" && (x = "text/css"), x = _(p) || x, x.search("text/css") > -1 ? U = "css" : x.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? U = "javascript" : x.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? U = "html" : x.search(/test\/null/) > -1 && (U = "null"), U) : null;
      };
      function k(b, p) {
        return p.indexOf(b) !== -1;
      }
      function y(b, p, x) {
        this.parent = b || null, this.tag = p ? p.tag_name : "", this.indent_level = x || 0, this.parser_token = p || null;
      }
      function v(b) {
      ...
      v.prototype.get_parser_token = function() {
        ...
        var p = new y(this._current_frame, b, this._printer.indent_level);
        this._current_frame = p;
      }, v.prototype._try_pop_frame = function(b) {
        var p = null;
        return b && (p = b.parser_token, this._printer.indent_level = b.indent_level, this._current_frame = b.parent), p;
      }, v.prototype._get_frame = function(b, p) {
        for (var x = this._current_frame; x && b.indexOf(x.tag) === -1; ) {
          if (p && p.indexOf(x.tag) !== -1) {
            x = null;
            break;
          }
          x = x.parent;
        ...
        return x;
      }, v.prototype.try_pop = function(b, p) {
        var x = this._get_frame([b], p);
      ...
      function C(b, p, x, U) {
        this._source_text = b || "", p = p || {}, this._js_beautify = x, this._css_beautify = U, this._tag_stack = null;
        var L = new l(p, "html");
      ...
      C.prototype.beautify = function() {
        if (this._options.disabled)
          return this._source_text;
        var b = this._source_text, p = this._options.eol;
...
`);
        var x = b.match(/^[\t ]*/)[0], U = {
          text: "",
          type: ""
        }, L = new M(), T = new f(this._options, x), S = new u(b, this._options).tokenize();
        this._tag_stack = new v(T);
        for (var w = null, A = S.next(); A.type !== c.EOF; )
          A.type === c.TAG_OPEN || A.type === c.COMMENT ? (w = this._handle_tag_open(T, A, L, U, S), L = w) : A.type === c.ATTRIBUTE || A.type === c.EQUALS || A.type === c.VALUE || A.type === c.TEXT && !L.tag_complete ? w = this._handle_inside_tag(T, A, L, U) : A.type === c.TAG_CLOSE ? w = this._handle_tag_close(T, A, L) : A.type === c.TEXT ? w = this._handle_text(T, A, L) : A.type === c.CONTROL_FLOW_OPEN ? w = this._handle_control_flow_open(T, A) : A.type === c.CONTROL_FLOW_CLOSE ? w = this._handle_control_flow_close(T, A) : T.add_raw_token(A), U = w, A = S.next();
        var R = T._output.get_code(p);
        return R;
      }, C.prototype._handle_control_flow_open = function(b, p) {
        var x = {
          text: p.text,
          type: p.type
        };
        return b.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), p.newlines ? b.print_preserved_newlines(p) : b.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), b.print_token(p), b.indent(), x;
      }, C.prototype._handle_control_flow_close = function(b, p) {
        var x = {
          text: p.text,
          type: p.type
        };
        return b.deindent(), p.newlines ? b.print_preserved_newlines(p) : b.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), b.print_token(p), x;
      }, C.prototype._handle_tag_close = function(b, p, x) {
        var U = {
          text: p.text,
          type: p.type
        };
        return b.alignment_size = 0, x.tag_complete = !0, b.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), x.is_unformatted ? b.add_raw_token(p) : (x.tag_start_char === "<" && (b.set_space_before_token(p.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && x.has_wrapped_attrs && b.print_newline(!1)), b.print_token(p)), x.indent_content && !(x.is_unformatted || x.is_content_unformatted) && (b.indent(), x.indent_content = !1), !x.is_inline_element && !(x.is_unformatted || x.is_content_unformatted) && b.set_wrap_point(), U;
      }, C.prototype._handle_inside_tag = function(b, p, x, U) {
        var L = x.has_wrapped_attrs, T = {
          text: p.text,
          type: p.type
        };
        return b.set_space_before_token(p.newlines || p.whitespace_before !== "", !0), x.is_unformatted ? b.add_raw_token(p) : x.tag_start_char === "{" && p.type === c.TEXT ? b.print_preserved_newlines(p) ? (p.newlines = 0, b.add_raw_token(p)) : b.print_token(p) : (p.type === c.ATTRIBUTE ? b.set_space_before_token(!0) : (p.type === c.EQUALS || p.type === c.VALUE && p.previous.type === c.EQUALS) && b.set_space_before_token(!1), p.type === c.ATTRIBUTE && x.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (b.traverse_whitespace(p), L = L || p.newlines !== 0), this._is_wrap_attributes_force && x.attr_count >= this._options.wrap_attributes_min_attrs && (U.type !== c.TAG_OPEN || // ie. second attribute and beyond
        this._is_wrap_attributes_force_expand_multiline) && (b.print_newline(!1), L = !0)), b.print_token(p), L = L || b.previous_token_wrapped(), x.has_wrapped_attrs = L), T;
      }, C.prototype._handle_text = function(b, p, x) {
        var U = {
          text: p.text,
          type: "TK_CONTENT"
        };
        return x.custom_beautifier_name ? this._print_custom_beatifier_text(b, p, x) : x.is_unformatted || x.is_content_unformatted ? b.add_raw_token(p) : (b.traverse_whitespace(p), b.print_token(p)), U;
      }, C.prototype._print_custom_beatifier_text = function(b, p, x) {
        var U = this;
        if (p.text !== "") {
          var L = p.text, T, S = 1, w = "", A = "";
          x.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? T = this._js_beautify : x.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? T = this._css_beautify : x.custom_beautifier_name === "html" && (T = function(q, J) {
            var se = new C(q, J, U._js_beautify, U._css_beautify);
            return se.beautify();
          }), this._options.indent_scripts === "keep" ? S = 0 : this._options.indent_scripts === "separate" && (S = -b.indent_level);
          var R = b.get_full_indent(S);
...
`) !== -1) && (I = I[3].match(/[ \t]+$/), I && (p.whitespace_before = I[0]));
          }
          if (L)
            if (T) {
              var F = function() {
...
` + R);
          ...
          w && (L ? L = w + L + `
` + A : L = w + A), b.print_newline(!1), L && (p.text = L, p.whitespace_before = "", p.newlines = 0, b.add_raw_token(p), b.print_newline(!0));
        }
      }, C.prototype._handle_tag_open = function(b, p, x, U, L) {
        var T = this._get_tag_open_token(p);
        if ((x.is_unformatted || x.is_content_unformatted) && !x.is_empty_element && p.type === c.TAG_OPEN && !T.is_start_tag ? (b.add_raw_token(p), T.start_tag_token = this._tag_stack.try_pop(T.tag_name)) : (b.traverse_whitespace(p), this._set_tag_position(b, p, T, x, U), T.is_inline_element || b.set_wrap_point(), b.print_token(p)), T.is_start_tag && this._is_wrap_attributes_force) {
          var S = 0, w;
          do
            w = L.peek(S), w.type === c.ATTRIBUTE && (T.attr_count += 1), S += 1;
          while (w.type !== c.EOF && w.type !== c.TAG_CLOSE);
        }
        return (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (T.alignment_size = p.text.length + 1), !T.tag_complete && !T.is_unformatted && (b.alignment_size = T.alignment_size), T;
      };
      var M = function(b, p) {
      ...
      C.prototype._get_tag_open_token = function(b) {
      ...
      }, C.prototype._set_tag_position = function(b, p, x, U, L) {
        if (x.is_empty_element || (x.is_end_tag ? x.start_tag_token = this._tag_stack.try_pop(x.tag_name) : (this._do_optional_end_element(x) && (x.is_inline_element || b.print_newline(!1)), this._tag_stack.record_tag(x), (x.tag_name === "script" || x.tag_name === "style") && !(x.is_unformatted || x.is_content_unformatted) && (x.custom_beautifier_name = g(x.tag_check, p)))), k(x.tag_check, this._options.extra_liners) && (b.print_newline(!1), b._output.just_added_blankline() || b.print_newline(!0)), x.is_empty_element) {
          ...
          x.tag_name === "!--" && L.type === c.TAG_CLOSE && U.is_end_tag && x.text.indexOf(`
`) === -1 || (x.is_inline_element || x.is_unformatted || b.print_newline(!1), this._calcluate_parent_multiline(b, x));
        } else if (x.is_end_tag) {
          var S = !1;
          S = x.start_tag_token && x.start_tag_token.multiline_content, S = S || !x.is_inline_element && !(U.is_inline_element || U.is_unformatted) && !(L.type === c.TAG_CLOSE && x.start_tag_token === U) && L.type !== "TK_CONTENT", (x.is_content_unformatted || x.is_unformatted) && (S = !1), S && b.print_newline(!1);
        } else
      ...
      }, C.prototype._calcluate_parent_multiline = function(b, p) {
        p.parent && b._output.just_added_newline() && !((p.is_inline_element || p.is_unformatted) && p.parent.is_inline_element) && (p.parent.multiline_content = !0);
      };
      var D = ["address", "article", "aside", "blockquote", "details", "div", "dl", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hr", "main", "menu", "nav", "ol", "p", "pre", "section", "table", "ul"], N = ["a", "audio", "del", "ins", "map", "noscript", "video"];
      C.prototype._do_optional_end_element = function(b) {
        var p = null;
        if (!(b.is_empty_element || !b.is_start_tag || !b.parent)) {
          if (b.tag_name === "body")
            ...
            (!x || N.indexOf(x.tag_name) === -1) && (p = p || this._tag_stack.try_pop("p"));
          } else
            b.tag_name === "rp" || b.tag_name === "rt" ? (p = p || this._tag_stack.try_pop("rt", ["ruby", "rtc"]), p = p || this._tag_stack.try_pop("rp", ["ruby", "rtc"])) : b.tag_name === "optgroup" ? p = p || this._tag_stack.try_pop("optgroup", ["select"]) : b.tag_name === "option" ? p = p || this._tag_stack.try_pop("option", ["select", "datalist", "optgroup"]) : b.tag_name === "colgroup" ? p = p || this._tag_stack.try_pop("caption", ["table"]) : b.tag_name === "thead" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"])) : b.tag_name === "tbody" || b.tag_name === "tfoot" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"]), p = p || this._tag_stack.try_pop("thead", ["table"]), p = p || this._tag_stack.try_pop("tbody", ["table"])) : b.tag_name === "tr" ? (p = p || this._tag_stack.try_pop("caption", ["table"]), p = p || this._tag_stack.try_pop("colgroup", ["table"]), p = p || this._tag_stack.try_pop("tr", ["table", "thead", "tbody", "tfoot"])) : (b.tag_name === "th" || b.tag_name === "td") && (p = p || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"]), p = p || this._tag_stack.try_pop("th", ["table", "thead", "tbody", "tfoot", "tr"]));
    ...
    function(r, s, a) {
      var l = a(9).Tokenizer, o = a(9).TOKEN, u = a(13).Directives, c = a(14).TemplatablePattern, d = a(12).Pattern, m = {
        ...
        if (this.__patterns = {
          ...
          this.__patterns.unformatted_content_delimiter = v.matching(C).until_after(C);
        }
      };
      _.prototype = new l(), _.prototype._is_comment = function(g) {
        return !1;
      }, _.prototype._is_opening = function(g) {
        return g.type === m.TAG_OPEN || g.type === m.CONTROL_FLOW_OPEN;
      }, _.prototype._is_closing = function(g, k) {
      ...
      }, _.prototype._get_next_token = function(g, k) {
        var y = null;
        this._readWhitespace();
      ...
      }, _.prototype._read_comment_or_cdata = function(g) {
        var k = null, y = null, v = null;
        if (g === "<") {
          var C = this._input.peek(1);
          C === "!" && (y = this.__patterns.comment.read(), y ? (v = f.get_directives(y), v && v.ignore === "start" && (y += f.readIgnored(this._input))) : y = this.__patterns.cdata.read()), y && (k = this._create_token(m.COMMENT, y), k.directives = v);
        }
        return k;
      }, _.prototype._read_processing = function(g) {
        var k = null, y = null, v = null;
        if (g === "<") {
          var C = this._input.peek(1);
          (C === "!" || C === "?") && (y = this.__patterns.conditional_comment.read(), y = y || this.__patterns.processing.read()), y && (k = this._create_token(m.COMMENT, y), k.directives = v);
        }
        return k;
      }, _.prototype._read_open = function(g, k) {
        var y = null, v = null;
        return (!k || k.type === m.CONTROL_FLOW_OPEN) && g === "<" && (y = this._input.next(), this._input.peek() === "/" && (y += this._input.next()), y += this.__patterns.element_name.read(), v = this._create_token(m.TAG_OPEN, y)), v;
      }, _.prototype._read_open_handlebars = function(g, k) {
        var y = null, v = null;
        return (!k || k.type === m.CONTROL_FLOW_OPEN) && this._options.indent_handlebars && g === "{" && this._input.peek(1) === "{" && (this._input.peek(2) === "!" ? (y = this.__patterns.handlebars_comment.read(), y = y || this.__patterns.handlebars.read(), v = this._create_token(m.COMMENT, y)) : (y = this.__patterns.handlebars_open.read(), v = this._create_token(m.TAG_OPEN, y))), v;
      }, _.prototype._read_control_flows = function(g, k) {
        var y = "", v = null;
        ...
        if (g === "@") {
          if (y = this.__patterns.angular_control_flow_start.read(), y === "")
            return v;
          for (var C = y.endsWith("(") ? 1 : 0, M = 0; !(y.endsWith("{") && C === M); ) {
          ...
          g === "}" && k && k.type === m.CONTROL_FLOW_OPEN && (y = this._input.next(), v = this._create_token(m.CONTROL_FLOW_CLOSE, y));
        return v;
      }, _.prototype._read_close = function(g, k) {
        var y = null, v = null;
        return k && k.type === m.TAG_OPEN && (k.text[0] === "<" && (g === ">" || g === "/" && this._input.peek(1) === ">") ? (y = this._input.next(), g === "/" && (y += this._input.next()), v = this._create_token(m.TAG_CLOSE, y)) : k.text[0] === "{" && g === "}" && this._input.peek(1) === "}" && (this._input.next(), this._input.next(), v = this._create_token(m.TAG_CLOSE, "}}"))), v;
      }, _.prototype._read_attribute = function(g, k, y) {
        var v = null, C = "";
        if (y && y.text[0] === "<")
          if (g === "=")
            ...
            g === '"' ? M += this.__patterns.double_quote.read() : M += this.__patterns.single_quote.read(), v = this._create_token(m.VALUE, M);
          } else
            C = this.__patterns.attribute.read(), C && (k.type === m.EQUALS ? v = this._create_token(m.VALUE, C) : v = this._create_token(m.ATTRIBUTE, C));
        return v;
      }, _.prototype._is_content_unformatted = function(g) {
      ...
      }, _.prototype._read_raw_content = function(g, k, y) {
        var v = "";
        if (y && y.text[0] === "{")
          v = this.__patterns.handlebars_raw_close.read();
        else if (k.type === m.TAG_CLOSE && k.opened.text[0] === "<" && k.text[0] !== "/") {
          var C = k.opened.text.substr(1).toLowerCase();
          if (C === "script" || C === "style") {
            var M = this._read_comment_or_cdata(g);
            if (M)
              return M.type = m.TEXT, M;
            v = this._input.readUntil(new RegExp("</" + C + "[\\n\\r\\t ]*?>", "ig"));
          } else
            this._is_content_unformatted(C) && (v = this._input.readUntil(new RegExp("</" + C + "[\\n\\r\\t ]*?>", "ig")));
        }
        return v ? this._create_token(m.TEXT, v) : null;
      }, _.prototype._read_content_word = function(g, k) {
        var y = "";
...
function Kc(e, t, n) {
  ...
  if (t) {
    ...
    for (; c > 0 && Ia(i, c - 1); )
      c--;
    c === 0 || Da(i, c - 1) ? u = c : c < u && (u = c + 1);
    let d = e.offsetAt(t.end), m = d;
    for (; m < i.length && Ia(i, m); )
      m++;
    (m === i.length || Da(i, m)) && (d = m), t = $.create(e.positionAt(u), e.positionAt(d));
    ...
    if (r = d === i.length, i = i.substring(u, d), u !== 0) {
      const _ = e.offsetAt(re.create(t.start.line, 0));
      s = nh(e.getText(), _, n);
    }
  } else
    t = $.create(re.create(0, 0), e.positionAt(i.length));
  const l = {
    indent_size: a,
    indent_char: n.insertSpaces ? " " : "	",
    indent_empty_lines: be(n, "indentEmptyLines", !1),
    wrap_line_length: be(n, "wrapLineLength", 120),
    unformatted: Fn(n, "unformatted", void 0),
    content_unformatted: Fn(n, "contentUnformatted", void 0),
    ...
    extra_liners: Fn(n, "extraLiners", void 0),
...
`,
  ...
  let o = Zc(eh(i), l);
  if (s > 0) {
    const u = n.insertSpaces ? Ma(" ", a * s) : Ma("	", s);
    o = o.split(`
`).join(`
...
(() => {
  var e = { 470: (r) => {
    ...
    function a(o, u) {
      for (var c, d = "", m = 0, f = -1, _ = 0, g = 0; g <= o.length; ++g) {
        if (g < o.length)
          c = o.charCodeAt(g);
        else {
          if (c === 47)
            ...
            if (f !== g - 1 && _ === 2) {
              if (d.length < 2 || m !== 2 || d.charCodeAt(d.length - 1) !== 46 || d.charCodeAt(d.length - 2) !== 46) {
                if (d.length > 2) {
                  var k = d.lastIndexOf("/");
                  if (k !== d.length - 1) {
                    k === -1 ? (d = "", m = 0) : m = (d = d.slice(0, k)).length - 1 - d.lastIndexOf("/"), f = g, _ = 0;
                    continue;
                  }
              ...
              d.length > 0 ? d += "/" + o.slice(f + 1, g) : d = o.slice(f + 1, g), m = g - f - 1;
          f = g, _ = 0;
        } else
          c === 46 && _ !== -1 ? ++_ : _ = -1;
      }
    ...
    var l = { resolve: function() {
      ...
      for (var d = o.length, m = d - c, f = 1; f < u.length && u.charCodeAt(f) === 47; ++f)
        ;
      for (var _ = u.length - f, g = m < _ ? m : _, k = -1, y = 0; y <= g; ++y) {
        if (y === g) {
          if (_ > g) {
            ...
            m > g && (o.charCodeAt(c + y) === 47 ? k = y : y === 0 && (k = 0));
          break;
        }
        var v = o.charCodeAt(c + y);
        if (v !== u.charCodeAt(f + y))
          break;
        v === 47 && (k = y);
      }
      var C = "";
      for (y = c + k + 1; y <= d; ++y)
        y !== d && o.charCodeAt(y) !== 47 || (C.length === 0 ? C += ".." : C += "/..");
      return C.length > 0 ? C + u.slice(f + k) : (f += k, u.charCodeAt(f) === 47 && ++f, u.slice(f));
      ...
      if (u !== void 0 && u.length > 0 && u.length <= o.length) {
        if (u.length === o.length && u === o)
          return "";
        var _ = u.length - 1, g = -1;
        for (c = o.length - 1; c >= 0; --c) {
          var k = o.charCodeAt(c);
          if (k === 47) {
            if (!f) {
              d = c + 1;
              break;
            ...
            g === -1 && (f = !1, g = c + 1), _ >= 0 && (k === u.charCodeAt(_) ? --_ == -1 && (m = c) : (_ = -1, m = g));
        }
        return d === m ? m = g : m === -1 && (m = o.length), o.slice(d, m);
      }
      for (c = o.length - 1; c >= 0; --c)
      ...
      s(o);
      for (var u = -1, c = 0, d = -1, m = !0, f = 0, _ = o.length - 1; _ >= 0; --_) {
        var g = o.charCodeAt(_);
        if (g !== 47)
          d === -1 && (m = !1, d = _ + 1), g === 46 ? u === -1 ? u = _ : f !== 1 && (f = 1) : u !== -1 && (f = -1);
        else if (!m) {
          c = _ + 1;
          break;
        }
      ...
      m ? (u.root = "/", c = 1) : c = 0;
      for (var f = -1, _ = 0, g = -1, k = !0, y = o.length - 1, v = 0; y >= c; --y)
        if ((d = o.charCodeAt(y)) !== 47)
          g === -1 && (k = !1, g = y + 1), d === 46 ? f === -1 ? f = y : v !== 1 && (v = 1) : f !== -1 && (v = -1);
        else if (!k) {
          _ = y + 1;
          break;
        }
      return f === -1 || g === -1 || v === 0 || v === 1 && f === g - 1 && f === _ + 1 ? g !== -1 && (u.base = u.name = _ === 0 && m ? o.slice(1, g) : o.slice(_, g)) : (_ === 0 && m ? (u.name = o.slice(1, f), u.base = o.slice(1, g)) : (u.name = o.slice(_, f), u.base = o.slice(_, g)), u.ext = o.slice(f, g)), _ > 0 ? u.dir = o.slice(0, _ - 1) : m && (u.dir = "/"), u;
  ...
  (() => {
    ...
    const u = "", c = "/", d = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
    class m {
      constructor(T, S, w, A, R, I = !1) {
        Fe(this, "scheme");
        Fe(this, "authority");
        Fe(this, "path");
        Fe(this, "query");
        Fe(this, "fragment");
        typeof T == "object" ? (this.scheme = T.scheme || u, this.authority = T.authority || u, this.path = T.path || u, this.query = T.query || u, this.fragment = T.fragment || u) : (this.scheme = /* @__PURE__ */ function(F, H) {
          return F || H ? F : "file";
        }(T, I), this.authority = S || u, this.path = function(F, H) {
          switch (F) {
            case "https":
            case "http":
            case "file":
          ...
          return H;
        }(this.scheme, w || u), this.query = A || u, this.fragment = R || u, o(this, I));
      }
      static isUri(T) {
      ...
      with(T) {
        if (!T)
          return this;
        let { scheme: S, authority: w, path: A, query: R, fragment: I } = T;
        return S === void 0 ? S = this.scheme : S === null && (S = u), w === void 0 ? w = this.authority : w === null && (w = u), A === void 0 ? A = this.path : A === null && (A = u), R === void 0 ? R = this.query : R === null && (R = u), I === void 0 ? I = this.fragment : I === null && (I = u), S === this.scheme && w === this.authority && A === this.path && R === this.query && I === this.fragment ? this : new _(S, w, A, R, I);
      }
      static parse(T, S = !1) {
        const w = d.exec(T);
        return w ? new _(w[2] || u, N(w[4] || u), N(w[5] || u), N(w[7] || u), N(w[9] || u), S) : new _(u, u, u, u, u);
      }
      static file(T) {
        let S = u;
        if (r && (T = T.replace(/\\/g, c)), T[0] === c && T[1] === c) {
          const w = T.indexOf(c, 2);
          w === -1 ? (S = T.substring(2), T = c) : (S = T.substring(2, w), T = T.substring(w) || c);
        }
        return new _("file", S, T, u, u);
      }
      static from(T) {
        const S = new _(T.scheme, T.authority, T.path, T.query, T.fragment);
        return o(S, !0), S;
      }
      toString(T = !1) {
        return C(this, T);
      ...
      static revive(T) {
        if (T) {
          ...
          {
            const S = new _(T);
            return S._formatted = T.external, S._fsPath = T._sep === f ? T.fsPath : null, S;
          }
        }
        return T;
      }
    ...
    class _ extends m {
      constructor() {
        super(...arguments);
        Fe(this, "_formatted", null);
        Fe(this, "_fsPath", null);
      }
      get fsPath() {
        return this._fsPath || (this._fsPath = v(this, !1)), this._fsPath;
      }
      toString(S = !1) {
        return S ? C(this, !0) : (this._formatted || (this._formatted = C(this, !1)), this._formatted);
      }
      toJSON() {
        const S = { $mid: 1 };
    ...
    function k(L, T, S) {
      ...
      for (let R = 0; R < L.length; R++) {
        const I = L.charCodeAt(R);
        if (I >= 97 && I <= 122 || I >= 65 && I <= 90 || I >= 48 && I <= 57 || I === 45 || I === 46 || I === 95 || I === 126 || T && I === 47 || S && I === 91 || S && I === 93 || S && I === 58)
          A !== -1 && (w += encodeURIComponent(L.substring(A, R)), A = -1), w !== void 0 && (w += L.charAt(R));
        else {
          w === void 0 && (w = L.substr(0, R));
          const F = g[I];
          F !== void 0 ? (A !== -1 && (w += encodeURIComponent(L.substring(A, R)), A = -1), w += F) : A === -1 && (A = R);
        }
      }
      return A !== -1 && (w += encodeURIComponent(L.substring(A))), w !== void 0 ? w : L;
    }
    function y(L) {
      let T;
      for (let S = 0; S < L.length; S++) {
        const w = L.charCodeAt(S);
        w === 35 || w === 63 ? (T === void 0 && (T = L.substr(0, S)), T += g[w]) : T !== void 0 && (T += L[S]);
      }
      return T !== void 0 ? T : L;
    }
    function v(L, T) {
      let S;
      return S = L.authority && L.path.length > 1 && L.scheme === "file" ? `//${L.authority}${L.path}` : L.path.charCodeAt(0) === 47 && (L.path.charCodeAt(1) >= 65 && L.path.charCodeAt(1) <= 90 || L.path.charCodeAt(1) >= 97 && L.path.charCodeAt(1) <= 122) && L.path.charCodeAt(2) === 58 ? T ? L.path.substr(1) : L.path[1].toLowerCase() + L.path.substr(2) : L.path, r && (S = S.replace(/\//g, "\\")), S;
    }
    function C(L, T) {
      const S = T ? y : k;
      let w = "", { scheme: A, authority: R, path: I, query: F, fragment: H } = L;
      if (A && (w += A, w += ":"), (R || A === "file") && (w += c, w += c), R) {
        let W = R.indexOf("@");
        if (W !== -1) {
          const q = R.substr(0, W);
          R = R.substr(W + 1), W = q.lastIndexOf(":"), W === -1 ? w += S(q, !1, !1) : (w += S(q.substr(0, W), !1, !1), w += ":", w += S(q.substr(W + 1), !1, !0)), w += "@";
        }
        R = R.toLowerCase(), W = R.lastIndexOf(":"), W === -1 ? w += S(R, !1, !0) : (w += S(R.substr(0, W), !1, !0), w += R.substr(W));
      }
      if (I) {
      ...
      return F && (w += "?", w += S(F, !1, !1)), H && (w += "#", w += T ? H : k(H, !1, !1)), w;
    }
    function M(L) {
      try {
        return decodeURIComponent(L);
      } catch {
        return L.length > 3 ? L.substr(0, 3) + M(L.substr(3)) : L;
      }
    }
    const D = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function N(L) {
      return L.match(D) ? L.replace(D, (T) => M(T)) : L;
    }
    var b = n(470);
    const p = b.posix || b, x = "/";
    var U;
    (function(L) {
      L.joinPath = function(T, ...S) {
        return T.with({ path: p.join(T.path, ...S) });
      }, L.resolvePath = function(T, ...S) {
        let w = T.path, A = !1;
        w[0] !== x && (w = x + w, A = !0);
        let R = p.resolve(w, ...S);
        return A && R[0] === x && !T.authority && (R = R.substring(1)), T.with({ path: R });
      }, L.dirname = function(T) {
        if (T.path.length === 0 || T.path === x)
          return T;
        let S = p.dirname(T.path);
        return S.length === 1 && S.charCodeAt(0) === 46 && (S = ""), T.with({ path: S });
...
function sh(e, t, n, i) {
  ...
  return /^\#/i.test(t) ? e + t : /^\/\//i.test(t) ? (Je(e, "https://") ? "https" : "http") + ":" + t.replace(/^\s*/g, "") : n ? n.resolveReference(t, i || e) : t;
}
function ah(e, t, n, i, r, s) {
  const a = Mi(n);
  if (!rh(a, e.languageId))
    return;
  a.length < n.length && (i++, r--);
  const l = sh(e.uri, a, t, s);
  if (!l)
    return;
  const o = lh(l, e);
  return {
    range: $.create(e.positionAt(i), e.positionAt(r)),
    target: o
  };
}
var oh = 35;
function lh(e, t) {
  try {
    ...
    return n.scheme === "file" && n.query && (n = n.with({ query: null }), e = n.toString(
      /* skipEncodig*/
      !0
    )), n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === oh) ? n.with({ fragment: null }).toString(
      /* skipEncodig*/
      !0
    ) : e;
  } catch {
...
var uh = class {
  ...
  findDocumentLinks(e, t) {
      ...
      switch (r) {
        ...
        case z.AttributeValue:
          if (a && s && this.dataManager.isPathAttribute(a, s)) {
            ...
            if (!l) {
              const d = ah(e, t, c, i.getTokenOffset(), i.getTokenEnd(), o);
              d && n.push(d);
            }
            l && typeof o > "u" && (o = Mi(c), o && t && (o = t.resolveReference(o, e.uri))), l = !1, s = void 0;
          } else if (s === "id") {
            const c = Mi(i.getTokenText());
    ...
    for (const c of n) {
      const d = e.uri + "#";
      if (c.target && Je(c.target, d)) {
        const m = c.target.substring(d.length), f = u[m];
        if (f !== void 0) {
          const _ = e.positionAt(f);
...
function ch(e, t, n) {
  ...
  if (!r.tag)
    return [];
  const s = [], a = Ha(z.StartTag, e, r.start), l = typeof r.endTagStart == "number" && Ha(z.EndTag, e, r.endTagStart);
  return (a && Ua(a, t) || l && Ua(l, t)) && (a && s.push({ kind: pn.Read, range: a }), l && s.push({ kind: pn.Read, range: l })), s;
}
function za(e, t) {
  return e.line < t.line || e.line === t.line && e.character <= t.character;
}
function Ua(e, t) {
  return za(e.start, t) && za(t, e.end);
}
function Ha(e, t, n) {
  const i = _e(t.getText(), n);
  let r = i.scan();
  for (; r !== z.EOS && r !== e; )
    r = i.scan();
...
function hh(e, t) {
  ...
  return n;
  function r(s, a) {
    const l = Ti.create(s.name, s.kind, s.range, e.uri, a == null ? void 0 : a.name);
...
function vo(e, t, n) {
  const i = dh(t), r = $.create(e.positionAt(t.start), e.positionAt(t.end)), s = ki.create(i, void 0, xi.Field, r, r);
...
function Wa(e, t, n) {
  ...
  r.endTagStart + 2 <= i && i <= r.endTagStart + 2 + s) ? [
    $.create(e.positionAt(r.start + 1), e.positionAt(r.start + 1 + s)),
    $.create(e.positionAt(r.endTagStart + 2), e.positionAt(r.endTagStart + 2 + s))
  ] : null;
}
var gh = class {
  constructor(e) {
  ...
  getFoldingRanges(e, t) {
    const n = this.dataManager.getVoidElements(e.languageId), i = _e(e.getText());
    let r = i.scan();
    const s = [], a = [];
    let l = null, o = -1;
    function u(d) {
      ...
      switch (r) {
        ...
        case z.StartTagSelfClose: {
          ...
          if (d >= 0) {
            const m = a[d];
            a.length = d;
            const f = e.positionAt(i.getTokenOffset()).line, _ = m.startLine, g = f - 1;
            g > _ && o !== _ && u({ startLine: _, endLine: g });
          }
          break;
        }
        case z.Comment: {
          ...
          if (f)
            if (f[1])
              ...
              if (_ >= 0) {
                ...
                a.length = _;
                const k = d;
                d = g.startLine, k > d && o !== d && u({ startLine: d, endLine: k, kind: dn.Region });
              }
            }
          else {
            const _ = e.positionAt(i.getTokenOffset() + i.getTokenLength()).line;
            d < _ && u({ startLine: d, endLine: _, kind: dn.Comment });
          }
          break;
        }
      }
  ...
  getSelectionRange(e, t, n) {
    ...
    for (let a = i.length - 1; a >= 0; a--) {
      const l = i[a];
      (!r || l[0] !== r[0] || l[1] !== r[1]) && (s = bn.create($.create(t.positionAt(i[a][0]), t.positionAt(i[a][1])), s)), r = l;
    }
    return s || (s = bn.create($.create(e, e))), s;
  }
  getApplicableRanges(e, t, n) {
    ...
    if (r.startTagEnd && !r.endTagStart) {
      ...
      const a = $.create(e.positionAt(r.startTagEnd - 2), e.positionAt(r.startTagEnd));
  ...
  getAttributeLevelRanges(e, t, n) {
    const i = $.create(e.positionAt(t.start), e.positionAt(t.end)), r = e.getText(i), s = n - t.start, a = _e(r);
    let l = a.scan();
    const o = t.start, u = [];
    let c = !1, d = -1;
    for (; l !== z.EOS; ) {
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
  ...
  setDataProviders(e, t) {
    this.dataProviders = [], e && this.dataProviders.push(new po("html5", _h)), this.dataProviders.push(...t);
  }
  getDataProviders() {
    return this.dataProviders;
  }
  isVoidElement(e, t) {
    return !!e && Lc(t, e.toLowerCase(), (n, i) => n.localeCompare(i)) >= 0;
  }
  getVoidElements(e) {
...
function xh(e = yh) {
  const t = new wh(e), n = new Xc(e, t), i = new Vc(e, t), r = new Cc(t), s = new bh(r), a = new gh(t), l = new uh(t);
  return {
    ...
    format: Kc,
    findDocumentHighlights: ch,
    findDocumentLinks: l.findDocumentLinks.bind(l),
    findDocumentSymbols: hh,
    ...
    doRename: mh,
    findMatchingTagPosition: ph,
    findOnTypeRenameRanges: Wa,
    findLinkedEditingRanges: Wa
  };
}
function Th(e, t) {
  return new po(e, t);
  ...
  constructor(e, t) {
    ...
    if (n != null && n.dataProviders)
      for (const s in n.dataProviders)
        r.push(Th(s, n.dataProviders[s]));
    this._languageService = xh({
